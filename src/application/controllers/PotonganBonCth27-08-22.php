...
class PotonganBon extends CI_Controller{
    ...
    function tambah_mst_item(){
        ...
        $this->template->display('potongan_bon/master/item/tambahItem',$data);
    }
   ...
   function lihat_pesanan_cicilan(){
    ...
    function detail_potongan_cicilan()
    {
        ...
        $data['_getDataTrnHdr'] = $this->M_PotonganBon->getDataTrnHdr($nofix,$periode);
        $data['_getDataCicilan'] = $this->M_PotonganBon->getDataCicilanDetail($nofix);
        $data['_getDataTotalCic'] = $this->M_PotonganBon->getDataTotalCicilan($nofix);
