...
class printexcel extends CI_Controller{
    ...
    function upload(){
        ...
        if($export == 1 && $Pendidikan == 1 && $Jenis_Kelamin == NULL){
        ...
        // if($export == 1){
        //     $data['getData']        = $this->m_print->toExcelAll($thn, $bln, $Pemborong, $Jenis_Kelamin);
        // }elseif($export == 2){
        //     $data['getData']        = $this->m_print->toExcelPost($thn, $bln);
        // }elseif($export == 3){
        //     $data['getData']        = $this->m_print->toExcelGagalview($thn, $bln);
    ...
    //         $data['listWo'] = $this->m_print->searchWO1($txtDeptAsal,$txtDate1,$txtDate2);
    //     }else{
    //         $data['listWo'] = $this->m_print->searchWO($txtDeptAsal,$txtDeptTerima,$txtDate1,$txtDate2);
    //     }
    ...
    function printdata()
    {
        ...
        //     $data['getData']        = $this->m_print->toExcelPost($thn, $bln);
        // }elseif($export == 3){
        //     $data['getData']        = $this->m_print->toExcelGagalview($thn, $bln, $Jenis_Kelamin, $Pemborong);
        // }elseif($export == 4){
        //     $data['getData']        = $this->m_print->toExcelNotview($thn, $bln);
        // }elseif($export == 5){
        //     $data['getData']        = $this->m_print->toExcelTelahview($thn, $bln);
        // }elseif($Pendidikan == 1){
        //     $data['getData']        = $this->m_print->toExcelSemua($Pemborong, $Jenis_Kelamin, $thn, $bln);
        // }elseif($Pendidikan == 2){
        //     $data['getData']        = $this->m_print->toExcelSemua1($Pemborong, $Jenis_Kelamin, $thn, $bln);
        // }else{
        //     $data['getData']        = $this->m_print->toExcelData($Pemborong, $Jenis_Kelamin, $thn, $bln);
