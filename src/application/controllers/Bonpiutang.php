...
class BonPiutang extends CI_Controller
{
	...
	{
		$jsadd = array(
			'jsadd/autoNumeric.min.js', 'jsadd/sweetalert.min.js', 'jsadd/bootstrap-select.min.js', 'jsadd/underscore-min.js', 'jsadd/backbone-min.js', 'jsadd/backdatatableserver.js',
			'jsadd/bonutang.js'
		);
	...
	public function storebon()
	{
		...
		foreach ($data as $itemmodel) {
			...
			if ($isexists) {
				...
				$param = array(
					'fixno' => decode_str($itemmodel->fixno), 'bon' => $bontk, 'periode' => $itemmodel->periode,
	...
	{
		$jsadd = array(
			'jsadd/bootstrap-select.min.js', 'jsadd/underscore-min.js', 'jsadd/backbone-min.js', 'jsadd/backdatatableserver.js',
	...
	{
		$jsadd = array(
			'jsadd/bootstrap-select.min.js', 'jsadd/underscore-min.js', 'jsadd/backbone-min.js', 'jsadd/format.min.js',                'jsadd/backdatatableserver.js',
	...
	public function havebontk()
	{
		...
		$param['coresearch'] = 'k.nik like @1 or k.nama like @1 or d.DeptAbbr like @1 or pek.Pekerjaan like @1';
	...
	public function utilbontk()
	{
		...
		$jsadd = array(
			'jsadd/moment-with-locales.min.js', 'jsadd/bootstrap-datetimepicker.min.js', 'jsadd/bootstrap-select.min.js', 'jsadd/underscore-min.js', 'jsadd/backbone-min.js', 'jsadd/format.min.js', 'jsadd/backdatatableserver.js',
	...
	public function unlockbontk()
	{
		...
		$jsadd = array(
			'jsadd/sweetalert.min.js', 'jsadd/bootstrap-select.min.js', 'jsadd/underscore-min.js', 'jsadd/backbone-min.js', 'jsadd/format.min.js', 'jsadd/backdatatableserver.js',
	...
	public function resetbontk()
	{
		...
		if ($isexists) {
			$param = array(
				$data->fixno, $data->periode, $data->lcid,
