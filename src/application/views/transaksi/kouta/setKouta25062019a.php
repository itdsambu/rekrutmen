<div class="row">
	<div class="col-xs-12">
		...
		<div class="form-group">
			<label class="control-label col-sm-3">Kuota Pendidikan</label>
			<div class="col-sm-7">
				<input type="text" class="form-control input-sm" onkeypress="return isNumber(event)" name="txtKuotaPendidikan" value="<?= $row->KuotaPendidikan?>">
			</div>
		</div>
		<div class="form-group">
			<label class="control-label col-sm-3">Kuota Non Pendidikan</label>
			<div class="col-sm-7">
				<input type="text" class="form-control input-sm" onkeypress="return isNumber(event)" name="txtKuotaNonPendidikan" value="<?= $row->KuotaNonPendidikan?>">
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<label class="control-label col-sm-3">End Input</label>
			<div class="col-sm-7">
				<div class="input-group bootstrap-timepicker">
					<input id="timepicker1" type="text" name="txtBatasInput" class="form-control input-sm" value="<?= date('H:i',strtotime($row->BatasInput))?>"/>
					<span class="input-group-addon">
						<i class="fa fa-clock-o bigger-110"></i>
					</span>
				</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
				...
				<textarea class="form-control" name="txtAlert" value="<?= $row->Alert?>"><?= $row->Alert?></textarea>
			</div>
		</div>
		<div class="form-group">
