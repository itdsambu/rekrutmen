    ...
    <div class="col-lg-12">
        <div class="widget-box">
            <div class="widget-header">
                <h4 class="widget-title">SDS TEST</h4>
            ...
            <form class="form-horizontal" role="form" method="POST" action="<?php echo base_url('PsychologicalAssisment/simpanDataSds')?>">
                    ...
                    <div class="col-lg-12">
                        ...
                        <!-- <div class="form-group">
                            <label class="col-lg-2 control-label">Nama Lengkap</label>
                                ...
                                <a href="#myModal" data-toggle="modal" id="btnFind" class="btn btn-success btn-sm" style="background-color: #B06408 !important; border-color: #B06408;">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div style="padding: 5px;"></div>
                        <table class="table table-hover table-striped table table-striped table-hover table-bordered" id="Sdstest">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header"> <!--style="background-color: #008cba">-->                
                ...
                <h4 class="modal-title">SDS Test</h4>
            </div>
            <div class="modal-body">
                <div id="lihat_detail" class="well">
                    <div class="form-group">
                        ...
                        <button type="button" id="btnCari" class="btn btn-sm btn-success" style="background-color: #B06408 !important; border-color: #B06408;" onclick="callAjax();"> 
...
<script type="text/javascript">
    function callAjax(){
        ...
        if(Nama == ''){
            ...
            $.ajax({
                type: "GET",
                dataType: "html",
                url: "<?php echo base_url('PsychologicalAssisment/getKaryawanSds')?>"+"/"+Nama,
    ...
    $("#btnFind").click(function(){
        ...
        if(id != ''){
            $.ajax({
                type: "POST",
                url : "<?php echo site_url('PsychologicalAssisment/getNamaSds')?>",
                data: {
                    'id' : id
                },
                success: function(msg){
    ...
    function pilih($id){
        ...
        if(id != ''){
            $.ajax({
                type: "POST",
                dataType: "html",
                url : "<?php echo site_url('PsychologicalAssisment/getNamaSds')?>"+"/"+id,
                success: function(msg){
                    $('#ajaxFormHeader').html(msg);
                }
            });
