    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <select class="form-control" id="inputDept" name="comboDept">
                <option value=""> -- Pilih </option>
                <?php if ($row->Pemborong == 'PSG') { ?>
                    <?php foreach ($getDeptPayroll as $rowDept) : ?>
                        <option value="<?php echo $rowDept->DeptID; ?>" <?php if ($rowDept->DeptID == $row->DeptID) {
                                                                            echo 'selected';
                                                                        } ?>>
                ...
                <?php if ($row->Pemborong == 'ALL PEMBORONG') { ?>
    ...
    <div class="form-group" id="divJabatan" style="display: <?php echo $disJabat; ?>;">
        ...
        <div class="col-sm-8">
            <select class="form-control" id="inputJabatan" name="comboJabatan">
                <option value=""> -- Pilih </option>
                <?php foreach ($getJbtnPayroll as $rowJbtn) : ?>
                    <option value="<?php echo $rowJbtn->JabatanID; ?>" <?php if ($rowJbtn->JabatanID == $row->PekerjaanID) {
                                                                            echo 'selected';
                                                                        } ?>><?php echo $rowJbtn->JabatanName; ?></option>
                <?php endforeach; ?>
            </select>
        </div>
    </div>
