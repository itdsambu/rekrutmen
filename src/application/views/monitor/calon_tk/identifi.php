<table id="dataTables-verifi" class="table table-striped table-bordered table-hover">
    <thead>
        <tr>
            <th>ID</th>
            <th>Nama</th>
    ...
    foreach ($_getTenaker as $set):
        ...
        ?>
            ...
            ?></td>
            <td><?php echo ucwords(strtolower($set->RegisteredBy));?></td>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#dataTables-verifi').dataTable();
        
        $("#dataTables-verifi").on("click", ".detail", function() {
        ...
        $("#dataTables-verifi").on("click", ".detailInfo", function() {
            var id = $(this).closest('tr').data('id');
            $.ajax({
