...
<?php foreach ($getUser as $row): 
    $NIK = $row->NIK;
endforeach;
$namafotoK='dataupload/Blacklist/'.trim($NIK).'.JPG';
$namafotoTK='dataupload/Blacklist/BORONGAN/'.trim($NIK).'.JPG';

// \\192.168.1.1\appl$\ID CARD\IMAGES\37441.jpg
// $namafoto = 'dataupload/fotoBlacklist/00001.jpg';
?>
<!-- <pre>
    <?php print_r($NIK);?>
</pre> -->
<div class="row">
    <?php foreach ($getUserK as $row): ?>
        <!-- <pre>
            <?php print_r($row);?>
        </pre> -->
    <div class="tabbable">
                    ...
                    <div class="col-xs-12 col-sm-7">
                        ...
                        <div class="profile-user-info profile-user-info-striped">
							...
							<div class="profile-info-row">
                                ...
                                <div class="profile-info-value">
                                    <span class="editable editable-click" id="age"><?php echo $row->TglLahir;?></span>
                                </div>
                            </div>
							<div class="profile-info-row">
                            ...
                            <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">
                                    <span class="editable editable-click" id="age"><?php echo $row->TglMasuk;?></span>
                                </div>
                            </div>
                            <div class="profile-info-row">
                                <div class="profile-info-name"> Tangal Keluar </div>
                                <div class="profile-info-value">
                                    <span class="editable editable-click" id="signup"><?php echo $row->TglKeluar;?></span>
                                </div>
                            </div>
                            <div class="profile-info-row">
