...
<div class="widget-main">  
    <form class="form-horizontal" role="form" method="POST" action="<?php echo base_url('Blacklist/filterdatalistBlacklistByPass');?>">
    <div class="row">
    ...
    <div class="col-xs-12">
        <div class="widget-box">
            <div class="widget-header">
                <h5 class="widget-title">List Masyarakat Bermasalah By Pass</h5>
                <div class="widget-toolbar">
                    <a class="btn btn-minier btn-danger" href="<?php echo base_url("blacklist/blacklistbypass");?>">
                ...
                <div class="widget-main">
                    <div class="table-responsive">
                        <table id="dataTablesTK" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                            <?php $no=0;
                            foreach ($getBlacklistByPass as $row):
                            ?>
                                <tr class="info" data-id="<?php echo $row->Detail;?>">
                                    <td><?php echo ++$no;?>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo site_url('blacklist/doEditFoto')."?id=".$row->Detail."&nama=".$row->Nama;?>" title="Upload Foto" class="btn btn-danger btn-round btn-minier">Upload Foto</a>
                                        <?php } else { ?>
                                        <?php } ?>
                                        <a href="#" title="Detail Blacklist By Pass" class="detail btn btn-minier btn-round btn-info"><i class="ace-icon fa fa-files-o bigger-100"></i>Detail</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                            </tbody>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"> Informasi Masyarakat Bermasalah By Pass</h4>
            </div>
