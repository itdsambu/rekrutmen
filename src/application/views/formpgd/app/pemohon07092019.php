        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="panel panel-default">
                    <div class="panel-heading"><b><i class="ace-icon fa fa-info"></i> Daftar Tanda Tangan Surat PGD</b></div>
                                    ...
                                    <td style="width: 100px;">
                                        ...
                                        <?php else:?>
                                            <span class="profil-picture">
                                                <img id="avatar" width="100" class="img-responsive" src="<?php echo base_url();?>dataupload/ttdpgd/nottd.png"></img>
                                            </span>
                                        <?php endif;?>
                                    </td>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table id="dataTables-listTK" class="table table-bordered">
                            ...
                            <tbody>
                                <?php if(empty($getdatapgdpemohon)){?>
                                <tr>
                                    <td class="text-center" colspan="7">Data Masih Kosong</td>
                                </tr>
                                <?php } else {
                                    $no=1;
                                    foreach ($getdatapgdpemohon as $r) {
                                ?>
                                <tr>
                                    <td><?php echo $no++;?></td>
                                    <td><?php echo trim($r->NIK);?></td>
