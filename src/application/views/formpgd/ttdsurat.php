<head>
    <!-- <link rel="stylesheet" href="<?php echo base_url();?>assets/signature/style.css" type="text/css" media="screen" />
    <link rel="stylesheet" href="<?php echo base_url();?>assets/signature/styles.css">
    <link rel="stylesheet" href="<?php echo base_url();?>assets/signature/style.css" type="text/css" media="screen" />
    </script><meta name="viewport" content="width=device-width, initial-scale=1">    
    <script src="<?php echo base_url();?>assets/signuture/jquery-1.10.2.js"></script>    
    <!-- <script type="text/javascript" src="<?php echo base_url();?>assets/signature/app.js"></script> -->

    
    <!-- <link href="<?php echo base_url(); ?>assets/signuture/style.css" rel="stylesheet">
    <script src="<?php echo base_url(); ?>assets/signuture/app.js" type="text/javascript"></script>
    <script src="<?php echo base_url(); ?>assets/signuture/jquery.min.js" type="text/javascript"></script> -->
    ...
    <div id="themain">
        ...
        <div id="btns">
            ...
            <form method="post" accept-charset="utf-8" id="form1" action="<?php echo base_url(); ?>Suratpgd/simpan_foto">
                ...
                <input type="hidden" name="DetailID" id="DetailID" value="<?php echo  $this->uri->segment(3); ?>"/>
                <input type="hidden" name="NIK" id="NIK" value="<?php echo  $this->uri->segment(4); ?>"/>
                <input type="text" name="txtnama" id="txtnama" value="<?php echo  $this->uri->segment(5); ?>"/>
                <input type="text" name="txtjabatan" id="txtjabatan" value="<?php echo  $this->uri->segment(6); ?>"/>
            </form>
        </div>
