    ...
    <div class="content-wrapper">
        ...
        <div class="content-body">
            ...
            <form action="<?= base_url() ?>" method="POST" id="send-data">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                ...
                                                                <input type="hidden" id="txtPerusahaan" class="form-control" name="txtPerusahaan" value="PT PULAU SAMBU" required>
                                                                <input type="hidden" id="txtPemborong" class="form-control" name="txtPemborong" value="PT PULAU SAMBU" required>
                                                                <input type="hidden" id="txtIDPemborong" class="form-control" name="txtIDPemborong" value="19" required>
                                                                <input type="hidden" id="txtSubPemborong" class="form-control" name="txtSubPemborong" value="PT PULAU SAMBU,63" required>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                ...
                                                                <small id="ktpError" class="text-danger" style="display: none;"></small> <!-- Error message -->
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                ...
                                                                <canvas id="pdfPreview" style="display: none; margin-top: 10px; max-width: 100%; height: auto; width: 150px; height: 100px;"></canvas> <!-- Preview canvas -->
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                ...
                                                                <small id="noKKError" class="text-danger" style="display:none;">No KK harus terdiri dari 16 digit angka.</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="form form-horizontal">
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12" id="inputSekolah" style="display: block;">
                                                        <div class="form-group row">
                                                            <div class="col-md-4">
                                                                    ...
                                                                    <table class="table table-bordered table-hover table-striped">
                                                                        <thead>
                                                                            <tr style="color: black;">
                                                                                <th class="table-secondary align-middle text-center checklist" style="color: black" rowspan="3" width="10">&#x2714;</th>
                                                                                <th class="table-secondary align-middle text-center" rowspan="3" style="width: 200px;">TINGKAT<br>(SD s/d S2)</th>
                                                                                <th class="table-secondary align-middle text-center" rowspan="3">NAMA SEKOLAH / TEMPAT </th>
                                                                                <th class="table-secondary align-middle text-center" rowspan="3">JURUSAN</th>
                                                                                <th class="table-secondary align-middle text-center" rowspan="3">Tahun<br> Masuk</th>
                                                                                <th class="table-secondary align-middle text-center" rowspan="3">Tahun<br> Keluar</th>
                                                                                <th class="table-secondary align-middle text-center" rowspan="3">LULUS</th>
                                                                            </tr>
                                                                        </thead>
                                                                        <tbody id="dataPendidikan">
                                                                            <tr>
                                                                                <td valign="top"><input name="chk[]" type="checkbox" /></td>
                                                                                <td>
                                                                                    <select class="form-control" id="inputTingkatanPendidikan" name="txtTingkatanPendidikan[]" required="" style="width: 200px;">
                                                                                        <option value="">-Pilih-</option>
                                                                                        <?php
                                                                                        foreach ($_getPendidikan as $rowPendidikan) :
                                                                                            echo "<option value ='$rowPendidikan->Pendidikan'>$rowPendidikan->Pendidikan</option>";
                                                                                ...
                                                                                <td>
                                                                                    <input type="text" name="txtNmSekolahPendidikan[]" autocomplete="off" id="inputNmSekolahPendidikan" class="form-control" style="width: 200px;">
                                                                                </td>
                                                                                <td>
                                                                                    <select class="form-control input-sm " name="txtJurusanPendidikan[]" id="inputJurusanPendidikan" style="display:none;width:200px;">
                                                                                ...
                                                                                <td>
                                                                                    <input type="text" name="txtThnMasukPendidikan[]" id="inputThnMasukPendidikan" class="form-control input-sm" maxlength="4" style="width: 200px;">
                                                                                </td>
                                                                                <td>
                                                                                    <input type="text" name="txtThnLulusPendidikan[]" id="inputThnLulusPendidikan" class="form-control input-sm" maxlength="4" style="width: 200px;">
                                                                                </td>
                                                                                <td>
                                                                                    <select class="form-control" id="inputLulusPendidikan" name="txtLulusPendidikan[]" style="width: 200px;">
                                                                        ...
                                                                        <tfoot class="bg-primary" id="dataPendidikanFoot">
                                                                            <tr>
                                                                                <td class="table-primary align-middle text-center" colspan="100%" align="center" style="background-color: #D3D3D3;">
                                                                                    <button type="button" class="btn btn-sm bg-gradient-success waves-effect waves-light" id="tambah_baris1" onClick="addRow('dataPendidikan')">Tambah Baris</button>
                                                                                    <button type="button" class="btn btn-sm bg-gradient-warning waves-effect waves-light" id="hapus_baris" onClick="deleteRow('dataPendidikan')">Hapus Baris</button>
                                                                                </td>
                                                                            </tr>
                                                                        </tfoot>
                                                                    </table>
                ...
                <section class="row flexbox-container" id="section-7" style="display: none;">
                    <div class="col-xl-12 col-7 d-flex justify-content-center mb-0">
                        <div class="col-md-6 col-12">
                            <div class="card">
                                <div class="card-header">
                                            ...
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            <div class="col-md-4">
                                                                <span>Keahlian/ Keterampilan yang dikuasai</span>
                                                            </div>
                                                            <div class="col-md-8">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            <div class="col-md-4">
                                                                <span>Pernah Kerja di SAMBU GROUP*</span>
                                                            </div>
                                                            <div class="col-md-8">
                                                                <ul class="list-unstyled mb-0">
                                                                    <li class="d-inline-block mr-2">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            <div class="col-md-4">
                                                                <span>Ada Keluarga yg Bekerja di SAMBU GROUP*</span>
                                                            </div>
                                                            <div class="col-md-8">
                                                                <ul class="list-unstyled mb-0">
                                                                    <li class="d-inline-block mr-2">
                                                    ...
                                                    <div class="col-12" id="listkeluarga" style="display: none;">
                                                        <div class="form-group row">
                                                            <div class="col-md-12">
                                                                <div class="table-responsive">
                                                                    <table class="table table-bordered table-hover table-striped">
                                                                        ...
                                                                        <tbody id="dataTable2">
                                                                            <tr>
                                                                                <td valign="top"><input name="chk[]" type="checkbox" /></td>
                                                                                <td>
                                                                                    <input type="text" name="kelnama[]" autocomplete="off" id="kelnama" class="form-control" style="width: 200px;" placeholder="Nama">
                                                                                </td>
                                                                                <td>
                                                                                    <input type="text" name="kelbagian[]" autocomplete="off" id="kelbagian" class="form-control" style="width: 200px;" placeholder="Bagian">
                                                                                </td>
                                                                                <td>
                                                                                    <input type="text" name="kelpemborong[]" autocomplete="off" id="kelpemborong" class="form-control" style="width: 200px;" placeholder="Pemborong">
                                                                                </td>
                                                                                <td>
                                                                                    <input type="text" name="kelhubungan[]" autocomplete="off" id="kelhubungan" class="form-control" style="width: 200px;" placeholder="Hubungan Keluarga">
                                                                                </td>
                                                                                <td>
                                                                                    <input type="text" name="kelalamat[]" autocomplete="off" id="kelalamat" class="form-control" style="width: 200px;" placeholder="Alamat">
                                                                                </td>
                                                                        ...
                                                                        <tfoot class="bg-primary" id="dataTable2Foot">
                                                                            <tr>
                                                                                <td class="table-primary align-middle text-center" colspan="100%" align="center" style="background-color: #D3D3D3;">
                                                                                    <button type="button" class="btn btn-sm bg-gradient-success waves-effect waves-light" id="tambah_baris2" onClick="addRow('dataTable2')">Tambah Baris</button>
                                                                                    <button type="button" class="btn btn-sm bg-gradient-warning waves-effect waves-light" id="hapus_baris2" onClick="deleteRow('dataTable2')">Hapus Baris</button>
                                                                                </td>
                                                                            </tr>
                                                                        </tfoot>
                                                                    </table>
                                        ...
                                        <div class="form form-horizontal">
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <!-- Tombol Previous & Next -->
                                                    <div class="col-12 d-flex justify-content-between">
                                                        <button type="button" class="btn btn-secondary prev-btn" data-prev="8">Previous</button>
                                                        <button type="button" class="btn btn-primary next-btn" data-next="10">Next</button>
                                                        <!-- <button type="submit" class="btn btn-primary ">submit</button> -->
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" id="inputAhliWaris" class="form-control" name="txtAhliWaris" placeholder="Input Nama Ahli Waris" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <textarea type="text" id="inputAlamatAhliWaris" class="form-control" name="txtAlamatAhliWaris" placeholder="Input Alamat" required></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" id="inputHubunganAhliWaris" class="form-control" name="txtHubunganAhliWaris" placeholder="Input Hubungan Ahli Waris" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" id="txtnohpkerabatAhliWaris" class="form-control isNumberKey" name="txtnohpkerabatAhliWaris" placeholder="0822xxxxxx" required>
                                                            </div>
                                                        </div>
                                                    </div>
                ...
                <section class="row flexbox-container" id="section-11" style="display: none;">
                    <div class="col-xl-12 col-7 d-flex justify-content-center mb-0">
                        <div class="col-md-6 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title"><i class="feather icon-instagram"></i> Sosial Media yang Aktif</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        <div class="form form-horizontal">
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <!-- Tombol Previous & Next -->
                                                    <div class="col-12 d-flex justify-content-between">
                                                        <button type="button" class="btn btn-secondary prev-btn" data-prev="10">Previous</button>
                                                        <!-- <button type="button" class="btn btn-primary next-btn" data-next="11">Next</button> -->
