                    ...
                    <div class="card bg-authentication rounded-0 mb-0">
                        <div class="row m-0">
                            <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                <img src="<?= base_url() ?>new-assets/app-assets/images/pages/login.png" alt="branding logo">
                            </div>
                                        ...
                                        <div class="card-body pt-1">
                                            ...
                                            <form action="<?= base_url('check-login') ?>" method="post">
                                                <fieldset class="form-label-group form-group position-relative has-icon-left">
                                                    <input type="text" class="form-control" name="email" id="email" placeholder="Email / Username" required>
                                                ...
                                                <div class="form-group d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div class="text-right"><a href="<?= base_url('forgot-password') ?>" class="card-link">Lupa Password?</a></div>
                                                </div>
