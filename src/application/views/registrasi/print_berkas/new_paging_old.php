    ...
    <div class="col-xs-12">
        <div class="widget-box">
            <div class="widget-header">
                <h4 class="widget-title">List Tenaga Kerja yang <?php echo ($_selected == 0 ? 'Telah di Posting' : 'Lulus Interview');?></h4>
                            ...
                            <form class="form-horizontal" role="form" method="POST" action="<?php echo base_url('PrintControl/filterData');?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="selDataFilter" id="inputDataFilter" class="form-control input-sm" >
                                                <option value="0" <?php if($_selected == 0){ echo 'selected';}?> >Telah Posting</option>
                                                <option value="1" <?php if($_selected == 1){ echo 'selected';}?> >Lulus Wawancara</option>
                                            </select>
                                        </div>
                                        <script>
                                ...
                                <div class="col-xs-12 col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <script>
                                            $(document).ready(function(){$("#inputPemborong").keyup(function(){$.ajax({type:"POST",url:"<?php echo base_url(); ?>autocomplete/getPemborong",data:{keyword:$("#inputPemborong").val()},dataType:"json",success:function(o){o.length>0?($("#DropdownPemborong").empty(),$("#inputPemborong").attr("data-toggle","dropdown"),$("#DropdownPemborong").dropdown("toggle")):0==o.length&&$("#inputPemborong").attr("data-toggle",""),$.each(o,function(n,e){o.length>=0&&$("#DropdownPemborong").append('<li role="presentation" ><a role="menuitem dropdownnameli" class="dropdownlivalue">'+e.Pemborong+"</a></li>")})}})}),$("ul.txtpemborong").on("click","li a",function(){$("#inputPemborong").val($(this).text())})});
                                        </script>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-4">
