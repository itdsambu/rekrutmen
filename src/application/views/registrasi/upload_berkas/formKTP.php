<?php echo form_open_multipart('uploadBerkas/do_upload/ktp', array('id' => 'formUpload', 'class' => 'form-horizontal')); ?>
<div class="row center">
    <div class="col-xs-12">
        <div class="col-lg-offset-3 col-sm-6">
            <h4>Unggah KTP Atas Nama <strong><?php echo $namapelamar; ?></strong></h4>

            <h5>Silakan pilih <?php echo $namaberkas; ?> dari komputer dengan menekan tombol PILIH (format file PDF)</h5>

            <input type="hidden" name="txthdrid" value="<?php echo $hdrid; ?>">
