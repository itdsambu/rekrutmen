            ...
            <table style="width: 100%;">
                <tr>
                    <td rowspan="3" style="width: 15%; text-align: center;"> 
                        <img src="<?php echo base_url();?>assets/img/psg-logo.png" width="70" height="70" alt="rsup-logo"/>
                    </td>
                    <td style="text-align: center; width: 55%;" class="kop">PT. PULAU SAMBU - GUNTUNG</td>
                ...
                <tr>
                    ...
                    <td style="width: 1%;">:</td>
                    <td style="width: 14%;"> <?php echo $row->CVNama;?> </td>
                </tr>
                <tr>
            ...
            <table style="width: 100%;">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php foreach ($_getInterV as $set){    
                                if($set->JenisKerja == NULL || $set->JenisKerja == '0'){
                                    echo '............................................';
                                }else{
                                    echo ucwords(strtolower($set->JenisKerja));
                                }  
                            }
                            ?>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php foreach ($_getInterV as $set){
                                if($set->Shift == NULL || $set->Shift == '0' || $set->Shift == ''){
                                    echo '............................................';
                                }else{
                                    echo ucwords(strtolower(($set->Shift == 'Z'? 'Non Shift':$set->Shift)));
                                }
                            }
                            ?>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>: <span><?php 
                            foreach ($_getInterV as $set){
                                if($set->KepalaShift == NULL || $set->KepalaShift == '0'){
                                    echo '__________';
                                }else{
                                    echo ucwords(strtolower($set->KepalaShift));
                                }
                            }?> </span>
                        </td>
                        <td>Nama</td>
