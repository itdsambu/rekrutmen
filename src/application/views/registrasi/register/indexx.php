                                        ...
                                        <div class="col-sm-12 column table table-responsive">
                                            <table class="table table-bordered table-hover">
                                                ...
                                                ?>
                                                        ...
                                                        <td><select class="col-xs-12 col-sm-10 form-control input-sm" name="txtJurusanPendidikan[]" id="inputJurusanPendidikan" disabled>
                                                            <option value=""> -- Silahkan pilih Jurusan</option>
...
<script language="JavaScript">
    ...
    $('#inputTingkatanPendidikan').change(function(){
        ...
        if ( pd== 'D1' || pd== 'D2' || pd== 'D3' || pd== 'S1' || pd== 'S2' || pd== 'S3' || pd== 'SMA' || pd== 'SMU' || pd== 'SMK' || pd== 'MAN' ){
           // $('#inputJurusanPendidikan').css("display","block"); 
           document.getElementById('inputJurusanPendidikan').disabled = false;
       }else{
         // $('#inputJurusanPendidikan').css("display","none"); 
         document.getElementById('inputJurusanPendidikan').disabled = true;
