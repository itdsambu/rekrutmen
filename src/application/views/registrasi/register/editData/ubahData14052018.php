                            ...
                            <div class="col-sm-9">
                                <select class="col-xs-10 col-sm-5" name="txtPerusahaan" id="inputPerusahaan">
                                    ...
                                    <?php foreach ($_getPSGPemborong as $rowCV): ?>
                                        <?php if($row->Perusahaan == $rowCV->Perusahaan):?>
...
//												$('#inputPerusahaan').attr("disabled",true);
            ...
            <div class="col-xs-12 col-sm-6">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label no-padding-right" for="inputAlamat"> Alamat </label>
                    <div class="col-sm-10">
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-2 control-label no-padding-right" for="inputRW"> RW </label>
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-10">
                        <select id="inputPendidikan" name="txtPendidikan" class="col-xs-10" onclick="PendidikanChange(this.value)">
                            ...
                            <?php foreach ($_getPendidikan as $rowPendikan): ?>
                                <?php if(strtoupper($row->Pendidikan) == strtoupper($rowPendikan->Pendidikan)):?>
...
//                                }
                                ...
                                <option value="CACAT" <?php // echo $yC;?>>CACAT</option>
                                <option value="NORMAL" <?php // echo $tC;?>>TIDAK CACAT</option>
                            </select>
                        </div>-->
                    </div>
                    <div class="form-group">
