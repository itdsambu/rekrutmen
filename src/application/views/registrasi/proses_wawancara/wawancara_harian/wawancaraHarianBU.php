<h4 class="row header smaller lighter orange">
    <span class="col-sm-8">
        ...
        Wawancara terhadap <strong><?php foreach ($datatk as $set){ echo ucwords(strtolower($set->Nama));}?></strong>,
...
<div class="table-responsive">
    <table class="table table-bordered">
        ...
        <tbody>
            <?php
                $no = 1;
                $no1 = 1; $no2 = 1; $no3 = 1; $no4 = 1; $no5 = 1;
                $no6 = 1; $no7 = 1; $no8 = 1; $no9 = 1; $no10 = 1;
                $no21 = 1; $no22 = 1; $no23 = 1; $no24 = 1; $no25 = 1;
                $no26 = 1; $no27 = 1; $no28 = 1; $no29 = 1; $no210 = 1;
