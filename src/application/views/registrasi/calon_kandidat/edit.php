...
<div class="row">
    ...
    <div class="col-sm-12 col-xs-12 m-t-20">
        <?php foreach ($data as $row) :
            ...
            echo form_open('Registrasi/updateDataCK?id=' . $row->ID, $att)
        ?>
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        ...
                        <input type="text" id="txtInputNama" name="txtNama" require class="form-control input-sm" placeholder="Nama" autofocus value="<?= $row->Nama ?>">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="text" id="txtInputTempatL" name="txtTempatL" require class="form-control input-sm" placeholder="Tempat Lahir" value="<?= $row->Tempat_Lhr ?>">
                    </div>
                    <div class="col-md-4">
                        <input type="text" id="txtInputTglL" name="txtTglL" require class="form-control input-sm datepick" placeholder="Tanggal Lahir" value="<?= $row->Tanggal_Lhr ?>">
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="text" id="txtInputNo_Ktp" name="txtNo_Ktp" require class="form-control input-sm" placeholder="No. KTP" maxlenght="16" value="<?= $row->NoKTP ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-4 control-label">No. HP</label>
                    <div class="col-md-8">
                        <input type="text" id="txtInputNoHP" name="txtNoHP" require class="form-control input-sm" placeholder="No. HP" maxlenght="12" value="<?= $row->NoHP ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-4 control-label">Email</label>
                    <div class="col-md-8">
                        <input type="text" id="txtInputEmail" name="txtEmail" require class="form-control input-sm" placeholder="example@example.com" value="<?= $row->Email ?>">
                    </div>
                </div>
            </div>
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <input type="text" id="txtInputPosisi" name="txtPosisi" require class="form-control input-sm" placeholder="Posisi" value="<?= $row->Posisi ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-4 control-label">Level</label>
                    <div class="col-md-5">
                        <input type="text" id="txtInputLevel" name="txtLevel" require class="form-control input-sm" placeholder="Level" value="<?= $row->Level ?>">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <select class="form-control input-sm btn btn-info btn-sm" id="selInputDept" name="selDept" required>
                            <option value="<?= $row->Dept ?>"><?= $row->DeptAbbr ?></option>
                            <option value="">-- pilih --</option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <select class="form-control input-sm btn btn-info btn-sm" id="selInputDivisi" name="selDivisi" required>
                            <option value="<?= $row->Divisi ?>"><?= $row->NamaDivisi ?></option>
                            <option value="">-- pilih --</option>
                            <?php
                ...
                <div class="form-group">
                    <label class="col-md-4 control-label">Jadwal Tes</label>
                    <div class="col-md-5">
                        <input type="text" id="txtInputJadwal" name="txtJadwal" require class="form-control input-sm datepick-days" placeholder="Jadwal Test" value="<?= $row->JadwalTest ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-4 control-label">Status</label>
                    <div class="col-md-5">
                        <select class="form-control input-sm btn btn-info btn-sm" id="selInputSts" name="selSts">
                            <?php if ($row->Status == 'L') { ?>
                ...
                <div class="form-group" id="biaya" style="display: none">
                    ...
                    <div class="col-md-5">
                        <input type="text" class="form-control input-sm" onkeypress="return isNumber(event)" name="txtBiaya" id="inputBiaya" value="<?= $row->Biaya ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-4 control-label">Sumber Pelamar</label>
                    <div class="col-md-5">
                        <input type="text" id="txtInputSumberPelamar" name="txtSumberPelamar" require class="form-control input-sm" placeholder="Sumber Pelamar" value="<?= $row->SumberPelamar ?>" required>
                    </div>
                </div>
            </div>
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <input type="text" id="txtInputKeterangan" name="txtKeterangan" require class="form-control input-sm" placeholder="Keterangan" value="<?= $row->Keterangan ?>" required>
                    </div>
                </div>
            </div>
            <div class="col-sm-12 text-right">
                <hr style="border:0;height:2px;background-image:linear-gradient(to right,rgba(19, 195, 177, 1),rgba(139, 244, 233, 1),rgba(0,0,0,0));">
                <button id="btnUpdate" type="submit" class="btn btn-sm btn-primary waves-effect waves-light"> <b>Simpan</b></button>
                <button id="btnCancel" type="reset" class="btn btn-sm btn-danger waves-effect waves-light"> <b>Batal</b></button>
            </div>
            </form>
        <?php endforeach; ?>
    </div>
