<?php echo form_open_multipart('Monitor/do_upload/cv', array('id' => 'formUpload','class'=>'form-horizontal')); ?>
    <div class="row center">
        <div class="col-xs-12">
            <div class="col-lg-offset-3 col-sm-6">
                    <h4>Unggah CV Atas Nama <strong><?php echo $namapelamar;?></strong></h4>
