...
<div class="row">
    <div class="col-xs-12">
        ...
        echo form_open('Blacklist/save', $att);?>
                                    ...
                                    <div class="row" id="ajaxFormHeader">
                                    	...
                                    	<div class="col-xs-6">
											<div class="form-group">
                                    			...
                                    			<div class="col-sm-9">
                                    				<input type="text" name="txttgllahir" id="tgllahir" placeholder="TANGGAL LAHIR" class="form-control" readonly>
                                    			</div>
                                    		</div>
											<div class="form-group">
                                    			<label class="col-sm-3 control-label no-padding-right" for="form-field-1" style="text-align: left;"> DAERAH ASAL</label>
                                    			<div class="col-sm-9">
                                    				<input type="text" name="txtdaerahasal" id="daerahasal" placeholder="DAERAH ASAL" class="form-control" readonly>
                                    			</div>
                                    		</div>
                                    		<div class="form-group">
...
//        alert("<?php // echo site_url('IssueIjinCuti/ajaxFormHeader')?>"+"/"+nik);
        if(nik == ''){
            ...
            $.ajax({
                type: "POST",
                url : "<?php echo site_url('Blacklist/ajaxeditblacklistTK')?>"+"/"+nik,
                success: function(msg){
                    $('#ajaxFormHeader').html(msg);
                }
            });
