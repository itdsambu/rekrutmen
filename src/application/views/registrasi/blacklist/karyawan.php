...
<div class="row">
    <div class="col-xs-12">
    	...
    	echo form_open('Blacklist/saveK', $att);?>
                            ...
                            <div class="widget-body">
                                <div class="widget-main">
                                    <div class="form-group">
                                    	<label class="col-sm-2 control-label margin">Cari Karyawan by NIK</label>
                                    ...
                                    <div class="row" id="ajaxFormHeader">
                                    	<div class="col-xs-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="txtnoktp" id="noktp" placeholder="NO KTP" class="form-control" readonly>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                    	...
                                    	<div class="col-xs-6">
                                    		<div class="form-group">
                                    			...
                                    			<div class="col-sm-9">
                                                    <input type="text" style="width: 600px;" name="txtketerangan" id="keterangan" placeholder="KETERANGAN" class="form-control">
                                    			</div>
                                    		</div>
                                    	</div>
                                    </div>
...
//        alert("<?php // echo site_url('IssueIjinCuti/ajaxFormHeader')?>"+"/"+nik);
        if(nik == ''){
            ...
            $.ajax({
                type: "POST",
                url : "<?php echo site_url('Blacklist/ajaxblacklistK')?>"+"/"+nik,
                success: function(msg){
                    $('#ajaxFormHeader').html(msg);
                }
            });
