...
<body class="skin-3 no-skin">
	...
	<script src="<?php echo base_url(); ?>assets/js/jsadd/jquery.dataTables.min.js"></script>
	<script src="<?php echo base_url(); ?>assets/js/jsadd/dataTables.bootstrap.min.js"></script>
