...
<div class="row">
   ...
   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="controlminmax">
       <div class="panel panel-default">
	       <div class="panel-heading">
		     <h3 class="panel-title">Setting Input Bon Masa kerja 3 bulan dan lebih.</h3>
		   </div>
	   </div>
	   <div class="panel-body">
	      <!--viewer -->
			<section id="viewer">
	 		<div class="col-sm-8">
	    		<table id="tblsettingbon" class="table table-striped table-hover table-nowrap table-colored">
        			<thead>
           				<tr>
              			<th>Pemborong</th>
              			<th>Min</th>
			     ...
			     <div class="form-horizontal">
				     <div class="form-group">
					     <div class="col-sm-12">
					       ...
					       <input readonly type="text" id="idperusahaan" name="idperusahaan" class="form-control input-sm">
						 </div>
					 </div>
					 <div class="form-group">
					     <div class="col-sm-5"><label class="control-label">Mk: 3 bulan</label></div>
						 <div class="col-sm-7"><input type="text" id="minvalue" class="numericval"></div>
					 </div>
					 <div class="form-group">
					     <div class="col-sm-5"><label class="control-label">Mk: > 3 bulan</label></div>
						 <div class="col-sm-7"><input type="text" id="maxvalue" class="numericval"></div>
					 </div>
				 </div>
				</div> 
				<div class="col-sm-12">
				   <button type="button" id="btnupdatenilai" class="btn btn-sm btn-primary">Update Data</button>
				</div>
			 </div>
			</section>
	   </div>    
