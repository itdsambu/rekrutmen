                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-sm-12 col-xs-12" id="getListPra">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4 col-sm-9 col-xs-12">
                                        <input type="text" name="txtNamaItem" id="txtNamaItem" class="form-control" placeholder="Nama Item" autocomplete="off" onkeyup="getSearchItem(this.value);" required>
                                    </div>
                                </div>
                                <div class="form-group">
...
//   }
    ...
    $(document).on('change', '#selectOption', function() { 
        let ItemID = $('#selectOption').val();
        let NamaItem = $('#selectOption option:selected').text();

        $('#txtItemID').val(ItemID);
        $('#txtNamaItem').val(NamaItem);
                ...
                success: function (response) {
                    ...
                    if (response.length == 0) {
                        ...
                        for (i = 0; i < response.length; i++) {
                            let Barcode = response[i].KodeBarkode;
