    ...
    <div class="col-lg-12">
        <div class="widget-box">
            <div class="widget-header">
                <h4 class="widget-title">TAMBAH MASTER KATEGORI CICILAN</h4>
            ...
            <form class="form-horizontal" role="form" method="POST" action="<?php echo base_url('PotonganBon/simpan_mst_cicilan');?>">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="number" name="txtPrioritas" class="form-control" placeholder="Prioritas">
                                    </div>
                                </div>
                                <div class="form-group">
