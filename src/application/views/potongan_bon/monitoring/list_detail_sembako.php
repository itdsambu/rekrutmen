                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="dataTables">
                            ...
                            <tbody>
                                <?php 
                                $no=1;
                                foreach($_getDataTotalSem1 as $get){?>
                                    <tr>
                                        <td style="vertical-align: middle;text-align: center;"><?php echo $no++?></td>
                                        <td style="vertical-align: middle;text-align: center;"><?php echo date('d-m-Y',strtotime($get->Tanggal))?></td>
                                        <td>
                                            <?php echo $get->NamaItem?>
                                        </td>
                                        <td>
                                            <?php echo $get->Quantity?>
                                        </td>
                                        <td>
                                            Rp <?php echo number_format($get->Harga,0,",",".")?>
                                        </td>
                                        <td>
                                            <?php echo $get->SingkatanSatuan?>
                                        </td>
                                        <td>
                                            <?php echo $get->NamaKategori?>
                                        </td>
                            ...
                            <tfoot>
                                <tr>
                                    <?php 
                                    foreach($_getDataTotalSem as $key){
