                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="dataTables">
                            ...
                            <tbody>
                                ...
                                foreach ($_getDataCicilan as $get) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $get->NamaCicilan ?>
                                        </td>
                                        <td><?php echo $get->Quantity ?>
                                        </td>
                                        <td>Rp.<?php echo number_format($get->Harga, 0, ",", ".") ?>
                                        </td>
                                        <td><?php echo $get->SingkatanSatuan ?>
                                        </td>

                                        <td><?php echo $get->NamaKategori ?>
                                        </td>
                                        <td style="vertical-align: middle;text-align: center;">Rp.<?php echo number_format($get->HargaCicilan, 0, ",", ".") ?>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                            <tfoot>
                                <tr>
                                    <?php
                                    foreach ($_getDataTotalCic as $key) {
                                        echo "<td colspan='7' class='text-center'><strong>GRAND TOTAL</strong></td>";
                                        echo "<td class='text-center'><strong>Rp." . number_format($key->grand, 0, ",", ".") . "</strong></td>";
                                    } ?>
                                </tr>
                            </tfoot>
                        </table>
