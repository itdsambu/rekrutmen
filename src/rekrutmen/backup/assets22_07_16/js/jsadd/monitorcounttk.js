...
var viewbontkpt = Backbone.View.extend({
	 ...
	 initialize : function(){
		 ...
		 var arcol = [
		     {'title':'Perusahaan','data':'perusahaan','width':'0'},
		 ...
		 view.bonpt.extraData = {"perusahaan":function(){var t=$('#selectperusahaan').selectpicker('val');return t;},
         ...
         view.bonpt.changedom = function(){
			this.defaultdomtable = 'l<"' + this.defaultdomchangeid +'"><"procecore"tr>ip'; 
		}		 
