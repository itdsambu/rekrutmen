...
class Form_interview extends CI_Controller
{
    ...
    //     $this->load->view('registrasi/form_interview/print/pf_interview');
    ...
    public function cetakpdf()
    {
        $data['title']   = 'Form Interview';
        $data['qbarang'] = $this->M_form_interview->getAllItem();
        // $data['_getDetail'] = $this->M_form_interview->get_detailtk();

        // ambil HTML dari view
        $html = $this->load->view('registrasi/form_interview/print/pf_interview', $data, true);

        // setting Dompdf
        $options = new Options();
        $options->set('isRemoteEnabled', true); // biar gambar kebaca
