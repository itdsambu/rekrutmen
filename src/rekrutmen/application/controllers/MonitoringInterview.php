...
class MonitoringInterview extends CI_Controller{
    ...
    function update(){
        ...
        $daerahasal     = $this->input->post('txtAsal');
    ...
    function list_data_berdasarkan_jurusan(){
        ...
        $this->load->view('monitor/interview/ajax_list_jurusan',$data);
    }

    function EksportExcel_berdasarkan_jurusan()
    {
        ...
        $this->load->view('monitor/interview/ExcelExport',$data);
    }
    ...
    function list_data_berdasarkan_gaji(){
        ...
        $data['gajiid'] = $gaji;
        $this->load->view('monitor/interview/ajax_list_gaji',$data);
    }

    function EksportExcel_berdasarkan_gaji()
    {
        $this->load->library("Excel/PHPExcel");
        $gaji = $this->input->get('gajiid');
    ...
    function list_data_berdasarkan_pendidikan(){
        ...
        $this->load->view('monitor/interview/ajax_list_pendidikan',$data);
    }

    function EksportExcel_berdasarkan_pendidikan()
    {
        $this->load->library("Excel/PHPExcel");
    ...
    function list_data_berdasarkan_tanggal(){
        ...
        $data['interview'] = $this->M_monitoringInterview->_getDataListBerdasarkanPertanggal($tglawal,$tglakhir);
        $data['tglawal'] = $tglawal;
        $data['tglakhir'] = $tglakhir;
        $this->load->view('monitor/interview/ajax_list_tanggal',$data);

    }
    
    function EksportExcel_berdasarkan_tanggal()
    {
        $this->load->library("Excel/PHPExcel");
