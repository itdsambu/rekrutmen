...
class Order extends CI_Controller
{
    ...
    function send_otp()
    {
        ...
        $get_tk = $this->M_Order->GetTK($nik, $nama, $nofix);
        ...
        echo '
            <div class="form-group">
                ...
                <div class="col-lg-3">
                    ...
                    <input type="hidden" name="txtSubPemborong" id="SubPemborong" class="form-control" value="' . $get_tk[0]->IDSubPemborong . '">
    ...
    function load_halaman_order()
    {
        ...
        $pbrid   = str_replace('%20', '', $this->uri->segment(3));
        $sub     = str_replace('%20', '', $this->uri->segment(4));
        ...
        // print_r($data);
        $cek_hdr = $this->M_Order->cek_header($tanggal, $nofix, $hdrid, $sub);
        if ($cek_hdr == NULL) {
            ...
            $data['_getItem'] = $this->M_Order->GetItem($sub);
            //echo $sub;
