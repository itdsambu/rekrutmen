...
use PhpOffice\PhpSpreadsheet\Style\Fill;
    ...
    public function exportxls()
    {
        ...
        $sheet->setBreak('A67', PHPExcel_Worksheet::BREAK_NONE);
        $sheet->setBreak('A68', PHPExcel_Worksheet::BREAK_NONE);

        $objPHPExcel->getActiveSheet()->setBreak('A' . ($header_row + 4),  PHPExcel_Worksheet::BREAK_ROW);
