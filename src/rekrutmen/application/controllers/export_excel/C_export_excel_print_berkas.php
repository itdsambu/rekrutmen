...
class C_export_excel_print_berkas extends CI_Controller
{

    public function __construct()
    {
        parent::__construct();
        // $this->load->model(array('m_posting'));
    }

    public function exportxls($data = NULL)
    {
        // $this->load->library("Excel/PHPExcel");
        $this->load->model(array('M_monitor', 'M_blacklist', 'M_posting_tenaker'));
        ...
        $tk_cancel = $this->M_posting_tenaker->getResultData($data);
        ...
        $objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('A' . ($start + 2), 'LIST CALON TENAGA KERJA');
