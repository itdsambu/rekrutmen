 ...
 */
 ...
 class Datatablesql{
    ...
    //SERVER SIDE
    private function get_fromtable($draw,$sqltotal,$sqldata,$sqlloop=null,$dbdef=null)
    {
	  $dbc = $this->db;
     ...
     //------------
      ...
      public function sql_select($param,$sqlfunctfrom,$sqlcorefield,$sqlwhereaddon=null,$sqlloop=null){
          $usingwhere = '';
          ...
          $ar = $this->get_fromtable($param['draw'],$sqlcount,$sqlselect,$sqlloop);
          return $ar;
      }
 }