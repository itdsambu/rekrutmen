...
<?php 
    ...
    echo form_open('Memopermintaan/multiApprovalManagement', $att);
?>
<div class="row">
    <div class="col-xs-12">
        <div class="widget-box">
            <div class="widget-header">
                <h4 class="widget-title">Approve Memo Permintaan By - Management</h4>
				   			...
				   			<?php } else { ?>
				   				<?php foreach($getmemodiv as $row){?>
				   					<tr class="info" data-id="<?php echo $row->IDMemo;?>">
										...
										<td>
											<a href="#" class="edit btn btn-default btn-sm">Edit</a>
											<a href="#" class="viewMemo btn btn-danger btn-sm">Memo</a>
										</td>
				   					</tr>
				   				<?php } ?>
				   			<?php } ?>
...
<div class="modal fade" id="EditMemo" tabindex="-1" role="dialog" aria-labelledby="viewModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dinamiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title">Edit Memo Permintaan Ideal TK/Karyawan</h4>
            </div>
            <div class="modal-body">
            	<input type="hidden" name="ideditMemo" id="inputeditMemo">
            	<div id="editMemo" class="well">
...
<script>
	$(document).ready(function(){
		...
		$('#dataTables').on("click", ".edit", function(){
			var id = $(this).closest('tr').data('id');
			$.ajax({
				url 	: "<?php echo site_url('Memopermintaan/editMemo');?>",
				type	: "POST",
				data 	: "kode="+id,
				datatype: "json",
				cache	: false,
