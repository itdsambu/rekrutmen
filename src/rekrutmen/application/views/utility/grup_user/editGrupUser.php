...
<div class="row">
    <div class="col-xs-12">
        ...
        echo form_open('grup_user/editGrupUser', $att);
                ...
                <div class="col-xs-12">
                    <div class="widget-box">
                        <div class="widget-header">
                            <h4 class="widget-title">Edit Grup User</h4>
                        ...
                        <div class="widget-body">
                            <div class="widget-main">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="hidden" id="inputIDGrup" name="txtIDGrup" value="<?php echo
                                        $row->GroupID; ?>" placeholder="ID Grup" class="col-xs-12 col-sm-10"
                                               required="required"/>
                                        <input type="text" id="inputGrupUser" name="txtGrupUser" value="<?php echo
                                            $row->GroupName; ?>" placeholder="Grup User" class="col-xs-12 col-sm-10"
                                               required="required"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="inputNamaGrup" name="txtNamaGrup" value="<?php echo
                                        $row->GroupDescription; ?>" placeholder="Nama Grup" class="col-xs-12 col-sm-10"
                                               required="required"/>
                                    </div>
                                </div>
                                <div class="form-group">
