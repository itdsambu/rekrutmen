            ...
            <div class="col-xs-12">
                <div class="widget-box">
                    <div class="widget-header">
                        <h4 class="widget-title">List Grup Name</h4>
                    ...
                    <div class="widget-body">
                        <div class="widget-main">
                            ...
                            <div class="table-responsive">
                                <table id="dataTables-PemborongAkses" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            <th>Grup Name</th>
                                            <th>CV Name</th>
                                    ...
                                    <tbody>
                                        <?php foreach ($getGroupAkses as $set):
                                            ?>
                                            <tr>
                                                <td><?php echo $set->GroupName;?></td>
                                                <td><?php echo $set->TokoName;?></td>
                                                ...
                                                <td><?php if($set->UpdatedDate===NULL){echo "Belum Terupdate"; }else{echo $set->UpdatedDate; }?></td>
                                                <td>
                                                    <a class="green tooltip-success" title="Edit GrupUser!" data-rel="tooltip" href="<?php echo site_url ('PemborongAkses/editAksesGroup')."?id=".$set->ID; ?>">
                                                        <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                    </a>
                                                    <a href="#" class="delete red bootbox-delete tooltip-error" data-id="<?php echo $set->ID;?>" data-name="<?php echo $set->GroupName;?>" title="Delete Grup User!" data-rel="tooltip">
                        ...
                        <div class="widget-toolbox padding-8 clearfix">
                            <a href="<?php echo base_url("PemborongAkses/add");?>" class="btn btn-xs btn-primary btn-bold pull-left">
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#dataTables-PemborongAkses').dataTable();
...
<script type="text/javascript">
    jQuery(function($) {
        $("#dataTables-PemborongAkses").on("click", ".delete", function() {
            let id = $(this).data('id');

            bootbox.confirm("Apakah anda yakin untuk menghapus Akses Pemborong dengan ID =  "+id+" ?", function(result) {
                if(result) {
                    window.location='deleteAkses?id='+id;
                }
            });
        });
    });
