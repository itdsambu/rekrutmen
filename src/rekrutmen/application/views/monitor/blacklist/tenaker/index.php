    ...
    <div class="col-xs-12">
        <div class="widget-box">
            <div class="widget-header">
                <h5 class="widget-title">List Tenaga Kerja Bermasalah</h5>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr class="info" data-id="<?php echo $row->NIK; ?>">
                                        ...
                                        <td data-order="<?php echo $row->TGLLAHIR; ?>">
                                            <?php echo date('d-m-Y', strtotime($row->TGLLAHIR)) ?>
                                        </td>
                                        <td>
                                            <?php echo $row->DAERAHASAL; ?>
                                        </td>
                                        <td data-order="<?php echo $row->TGLMASUK; ?>">
                                            <?php echo date('d-m-Y', strtotime($row->TGLMASUK)); ?>
                                        </td>
                                        <td data-order="<?php echo $row->TGLKELUAR; ?>">
                                            <?php echo date('d-m-Y', strtotime($row->TGLKELUAR)); ?>
                                        </td>
                                        <td>
                                            <?php echo $row->REMARK; ?>
                                        </td>
