                                    ...
                                    <div class="col-sm-12">
                                        <div class="table-responsive">
                                            <table id="dataTablesK" class="table table-hover table-bordered">
                                                ...
                                                <tbody>
                                                    <?php $no = 0;
                                                    foreach ($getBlacklistKRSUP as $rowK) { ?>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="table-responsive">
                                            <table id="dataTablesTK" class="table table-hover table-bordered">
                                                ...
                                                <tbody>
                                                    <?php $no = 0;
                                                    foreach ($getBlacklistTKRSUP as $rowTK) { ?>
                                                        <tr class="info" data-id="<?php echo $rowTK->RequestID; ?>">
                                                            ...
                                                            <td data-order="<?php echo $rowTK->TanggalKeluar; ?>">
                                                                <?php if ($rowTK->TanggalKeluar == NULL) {
                                                                    echo '';
                                                                } else {
                                                                    echo date('d-m-Y', strtotime($rowTK->TanggalKeluar));
                                                                }; ?>
                                                            </td>
                                                            <td data-order="<?php echo date('Y-m-d', strtotime($rowTK->TanggalKeluarTemporary)); ?>">
                                                                <?php if ($rowTK->TanggalKeluarTemporary == NULL) {
                                                                    echo '';
                                                                } else {
                                                                    echo date('d-m-Y', strtotime($rowTK->TanggalKeluarTemporary));
                                                                }; ?>
                                                            </td>
...
<script type="text/javascript" src="<?php echo base_url(); ?>rekrutmen/assets/moment.min.js"></script>
<script type="text/javascript" src="<? ?>/rekrutmen/assets/datetime-moment.js"></script>
