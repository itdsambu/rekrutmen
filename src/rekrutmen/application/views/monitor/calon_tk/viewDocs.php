...
<?php foreach ($_getViewDocs as $row) : ?>
    <?php
    if ($_jenisBerkas == "CV") { ?>
        <div class="form-line">
    ...
    <?php
        // } elseif ($_jenisBerkas == "NoKK") { 

    } elseif ($_jenisBerkas == "KK") { ?>
        <div class="form-line">
            <a href="<?php echo site_url($row->KK); ?>" class="btn btn-mini btn-success pull-right" target="_blank"><i class="ace-icon fa fa-print"></i> Print</a>
        </div>
        <div id="viewer" class="pdf-viewer" data-url="<?php echo base_url($row->KK); ?>"></div>
    <?php
    } elseif ($_jenisBerkas == "SKCK") { ?>
        <div class="form-line">
            <a href="<?php echo site_url($row->SKCK); ?>" class="btn btn-mini btn-success pull-right" target="_blank"><i class="ace-icon fa fa-print"></i> Print</a>
        </div>
        <div id="viewer" class="pdf-viewer" data-url="<?php echo base_url($row->SKCK); ?>"></div>
    <?php
    ...
    <?php
    } elseif ($_jenisBerkas == "Vaksin1") { ?>
        <div class="form-line">
            <a href="<?php echo site_url($row->Vaksin1); ?>" class="btn btn-mini btn-success pull-right" target="_blank"><i class="ace-icon fa fa-print"></i> Print</a>
        </div>
        <div id="viewer" class="pdf-viewer" data-url="<?php echo base_url($row->Vaksin1); ?>"></div>
    <?php
    } elseif ($_jenisBerkas == "Vaksin2") { ?>
        <div class="form-line">
            <a href="<?php echo site_url($row->Vaksin2); ?>" class="btn btn-mini btn-success pull-right" target="_blank"><i class="ace-icon fa fa-print"></i> Print</a>
        </div>
        <div id="viewer" class="pdf-viewer" data-url="<?php echo base_url($row->Vaksin2); ?>"></div>
    <?php
    } elseif ($_jenisBerkas == "Vaksin3") { ?>
        <div class="form-line">
            <a href="<?php echo site_url($row->Vaksin3); ?>" class="btn btn-mini btn-success pull-right" target="_blank"><i class="ace-icon fa fa-print"></i> Print</a>
        </div>
        <div id="viewer" class="pdf-viewer" data-url="<?php echo base_url($row->Vaksin3); ?>"></div>
    <?php
