    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            foreach ($_getKualifikasi as $rowNilai) :
                ...
                $Keterangan = $rowNilai->Keterangan;
            ?>
                <tr>
                    <td><?php echo $no++; ?></td>
                    ...
                    <td class="text-center">
                        <label class="pos-rel">
                            <input id="txtNilai<?php echo $no21++; ?>" <?= intval($rowNilai->Nilai) == 10 ? 'checked' : '' ?> name="txtNilai<?php echo $no1++; ?>" type="radio" class="ace" value="10" onclick="return changeVal()">
                            <span class="lbl"></span>
                        </label>
                    </td>
                    <td class="text-center">
                        <label class="pos-rel">
                            <input id="txtNilai<?php echo $no22++; ?>" <?= intval($rowNilai->Nilai) == 20 ? 'checked' : '' ?> name="txtNilai<?php echo $no2++; ?>" type="radio" class="ace" value="20" onclick="return changeVal()">
                            <span class="lbl"></span>
                        </label>
                    </td>
                    <td class="text-center">
                        <label class="pos-rel">
                            <input id="txtNilai<?php echo $no23++; ?>" <?= intval($rowNilai->Nilai) == 30 ? 'checked' : '' ?> name="txtNilai<?php echo $no3++; ?>" type="radio" class="ace" value="30" onclick="return changeVal()">
                            <span class="lbl"></span>
                        </label>
                    </td>
                    <td class="text-center">
                        <label class="pos-rel">
                            <input id="txtNilai<?php echo $no24++; ?>" <?= intval($rowNilai->Nilai) == 40 ? 'checked' : '' ?> name="txtNilai<?php echo $no4++; ?>" type="radio" class="ace" value="40" onclick="return changeVal()">
                            <span class="lbl"></span>
                        </label>
                    </td>
                    <td class="text-center">
                        <label class="pos-rel">
                            <input id="txtNilai<?php echo $no25++; ?>" <?= intval($rowNilai->Nilai) == 50 ? 'checked' : '' ?> name="txtNilai<?php echo $no5++; ?>" type="radio" class="ace" value="50" onclick="return changeVal()">
                            <span class="lbl"></span>
                        </label>
                    </td>
                    <td class="text-center">
                        <label class="pos-rel">
                            <input id="txtNilai<?php echo $no26++; ?>" <?= intval($rowNilai->Nilai) == 60 ? 'checked' : '' ?> name="txtNilai<?php echo $no6++; ?>" type="radio" class="ace" value="60" onclick="return changeVal()">
                            <span class="lbl"></span>
                        </label>
                    </td>
                    <td class="text-center">
...
<div class="form-group">
    <label>Catatan</label>
    <textarea name="txtCatatan" class="form-control" readonly><?= $Keterangan ?></textarea>
</div>
