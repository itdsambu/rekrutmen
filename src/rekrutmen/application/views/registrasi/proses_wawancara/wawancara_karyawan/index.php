    ...
    <div class="col-xs-12">
        <div class="widget-box">
            <div class="widget-header">
                <h4 class="widget-title">Wawancara Karyawan </h4>
                    ...
                    <?php
                        if($this->input->get('msg') == 'Success'){
                            echo "<p class='alert alert-info'><button type='button' class='close' data-dismiss='alert'>
                                    <i class='ace-icon fa fa-times'></i></button>Interview Karyawan Success!</p>";
                        }
                    ?>
                        ...
                        foreach ($_getTenagaKerja as $set):
                            ...
                            ?>
                                ...
                                <td class="text-center">
                                    ...
                                    <a title="do Interview" data-rel="tooltip" href="#" class="wawancara">
                                        <button class="btn btn-minier btn-round btn-primary">
                                            <i class="ace-icon fa fa-files-o bigger-100"></i> Wawancara</button>
                                    </a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#dataTables-listTK").on("click", ".wawancara", function() {
            ...
            $.ajax({
                url:"<?php echo site_url('wawancaraProses/doWawancaraKaryawan');?>",
                type:"POST",
                data:"kode="+id,
                datatype:"json",
                cache:false,
