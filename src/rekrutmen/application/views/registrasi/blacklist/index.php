...
<div class="row">
    <div class="col-xs-12">
        ...
        echo form_open('blacklist/tambah', $att);?>
        <!-- Design Disini -->
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="alert alert-block alert-danger"></button>
                            ...
                            <strong>Warning!!</strong> Registrasi Karyawan / Tenaga Kerja Bermasalah masih tahap pengembangan..<br>
                        </div>
                    </div>   
                    <div class="col-xs-12">
                        <div class="widget-box">
                            <div class="widget-header">
                                <h3 class="widget-title">Registrasi Karyawan / Tenaga Kerja Bermasalah</h3>
                                ...
                                <div class="widget-main">
                                    <div class="well-sm">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-1">
                                                <button id="btnFind" class="btn btn-sm btn-block btn-primary" type="button" ><i class="fa fa-search fa-2x"></i></i></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="widget-main" id="ajaxFormHeader">
                                    <div class="form-group">
                                        <label class="control-label col-xs-12 col-sm-2 no-padding-right" for="form-field-1"> Nama </label>
                                        <div class="col-sm-8">
                                            <input type="text" id="inputNama" name="txtNama" placeholder="Input Nama" class="col-xs-12 col-sm-10" required="" readonly="" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-xs-12 col-sm-2 no-padding-right" for="form-field-1"> Perusahaan/ CV </label>
                                        <div class="col-sm-8">
                                            <input type="text" id="inputPerusahaan" name="txtPerusahaan" placeholder="Input Nama" class="col-xs-12 col-sm-10" required="" readonly="" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="pt">
                                                <input type="text" id="inputPemborong" name="txtPemborong" placeholder="Pemborong Auto Value" class="col-xs-12 col-sm-10" readonly="" required="" readonly="" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="pt">
                                                <input type="text" id="inputDept" name="txtDept" placeholder="Dept Auto Value" class="col-xs-12 col-sm-10" readonly="" required="" readonly="" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Tangal Masuk </label>
                                        <div class="col-sm-3">
                                            <div class="input-group input-big date date-picker" data-date-format="dd/mm/yyyy" data-date-viewmode="days"  data-date-viewmode="years" data-date-minviewmode="months">
                                                <input type="text" class="form-control" name="txtMasuk" id="inputMasuk" required="" readonly=""  placeholder="dd/mm/yyyy">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Tangal Keluar </label>
                                        <div class="col-sm-3">
                                            <div class="input-group input-big date date-picker" data-date-format="dd/mm/yyyy" data-date-viewmode="days"  data-date-viewmode="years" data-date-minviewmode="months">
                                                <input type="text" class="form-control" name="txtKeluar" id="inputKeluar" required="" readonly=""  placeholder="dd/mm/yyyy">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="inputNamaIbu" name="txtNamaIbu" placeholder="Input Nama Ibu Kandung" class="col-xs-12 col-sm-10" required="" readonly="" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1">Keterangan</label>
                                        <div class="col-sm-8">
                                            <textarea type="text" id="inputKeterangan" name="txtKeterangan" placeholder="Keterangan" class="form-control col-xs-12 col-sm-10" required=""></textarea>
                                        </div>
                                    </div>
    ...
    $("#btnFind").click(function(){
       ...
       alert("<?php // echo site_url('IssueIjinCuti/ajaxFormHeader')?>"+"/"+nik);
        if(nik == ''){
            ...
            $.ajax({
                type: "POST",
                url : "<?php echo site_url('blacklist/ajaxeditblacklist')?>"+"/"+nik,
...
//         var durasi  = document.getElementById('inputDurasi').value;
//         var val     = this.value;
//         var nik = document.getElementById('findByNIK').value;
// //        alert(durasi+"/"+val);
//         $.ajax({
//             type:"POST",
//             data:"durasi="+durasi+"&tglMulai="+val,
//             datatype:"json",
//             cache:false,
//             url : "<?php echo site_url('IssueIjinCuti/ajaxFormDetail')?>"+"/"+nik,
//             success: function(msg){
//                 $('#ajaxFormDetail').html(msg);
//             }
//         });
