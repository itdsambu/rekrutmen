...
<div class="widget-box">
    <div class="widget-header">
        <h4 class="widget-title">Detail Laporan Data Karantina Pertanggal : <?php if (isset($detail) && count($detail) > 0) {
                                                                                echo date('d-m-Y', strtotime($detail[0]['create_date']));
                                                                            } else {
                                                                                echo '';
                                                                            }  ?></h4>
    </div>
                        ...
                        if (isset($detail)) {
                            foreach ($detail as $dtl) : ?>
                                <tr>
                                    ...
                                    <td><?php if ($dtl['tgl_masuk_karantina'] > '1900-01-01') {
                                            echo date('d-m-Y', strtotime($dtl['tgl_masuk_karantina']));
                                        } else {
                                        } ?></td>
                                    <td><?php echo $dtl['alamat_karantina']; ?></td>
                                    <td><?php echo $dtl['keterangan']; ?></td>
                                    <td><?php if ($dtl['status_karantina'] == '1') {
                                            echo "Lulus";
                                        } else if ($dtl['status_karantina'] == '0') {
                                            echo "Tidak Lulus";
                                        } else {
                                            echo "Masih Karantina";
                                        } ?></td>
