...
<script type="text/javascript">
    jQuery(function($) {
        ...
        $('#inputNoPonsel').mask('999999999999');
        $('#inputNoKK').mask('9999999999999999');
        $('#inputNoKTP').mask('9999999999999999');
        $('#inputIPK').mask('9.99');
        ...
        $('#formRegistrasi').validate({
            ...
            messages: {
                txtPerusahaan: {
                    required: "Silahkan Pilih Perusahaan/PT"
                },
                txtSubPemborong: {
                    required: "Silahkan Pilih Sub Pemborong"
                },
                txtNama: {
...
<div class="row">
    <div class="col-xs-12">
        ...
        <!-- Design Disini -->
        <form id="formRegistrasi" class="form-horizontal" action="<?php echo site_url('registrasi/simpanReg'); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-xs-12">
                        <div class="widget-box">
                            <div class="widget-header">
                                <h3 class="widget-title">Registrasi Tenaga Kerja Baruuuu</h3>
                                <br>
                                <br>
                                <div class="px-2 bg-light ">
                                    <marquee class="py-3" scrollamount="5">
                                        <span style="font-size:22px;">
                                            <p style="color:#FF0000" ;><b>PASTIKAN ANDA MENGINPUT DATA CALON TK DENGAN BENAR, JIKA TERJADI KESALAHAN PENGINPUTAN MAKA DATA TIDAK BISA DI EDIT DAN DATA TIDAK DAPAT DI PROSES LEBIH LANJUT !<b>
                            ...
                            <div class="widget-body">
                                <div class="widget-main">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-xs-12 col-sm-2 no-padding-right" for="form-field-1"> Perusahaan/ PT </label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Sub Pemborong </label>
                                        <div class="col-sm-8">
                                            <div id="subpt">
                                                <input type="text" id="inputSubPemborong" name="txtSubPemborong" placeholder="Sub Pemborong Auto Value" class="col-xs-12 col-sm-10" readonly="" required="" />
                                            </div>
                                        </div>
                                    </div>
                                    <script type="text/javascript">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="inputNamaLengkap" name="txtNama" placeholder="Input Nama Lengkap" class="col-xs-12 col-sm-10 txtNama" onkeypress="return DisableKey(event, 'alphabet')" required="" pattern="[a-z A-Z]*$" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> FILE KTP* </label>
                                        <div class="col-sm-8">
                                            <form id="uploadForm">
                                                <input type="file" id="pdfUpload" name="txtFileKTP" class="col-xs-12 col-sm-10" accept=".pdf" />
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> NO. KK* </label>
                                        <div class="col-sm-8">
                                            <input type="text" id="inputNoKK" name="txtNoKK" placeholder="Input No. KK" class="col-xs-12 col-sm-10" required="" minlength="16" maxlength="16" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Alamat Sesuai e-KTP* </label>
                                        <div class="col-sm-8">
                                            <textarea class="col-xs-12 col-sm-10" id="inputAlamatKtp" name="txtAlamatKTP" placeholder="Input Alamat Sesuai e-KTP" required=""></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-1">
                                            <input type="text" id="inputRT" name="txtRT" placeholder="RT" onkeypress="return isNumber(event)" required="" />
                                        </div>
                                        <label class="col-sm-1 control-label no-padding-right" for="form-field-1"> RW* </label>
                                        <div class="col-sm-1">
                                            <input type="text" id="inputRW" name="txtRW" placeholder="RW" onkeypress="return isNumber(event)" required="" />
                                        </div>
                                        <label class="col-sm-1 control-label no-padding-right" for="form-field-1"> Kelurahan*</label>
                                        <div class="col-sm-1">
                                            <input type="text" id="inputKelurahan" name="txtKelurahan" placeholder="Kelurahan" onkeypress="return /[a-zA-Z ]/i.test(event.key)" required="">
                                        </div>
                                    </div>
                                    <script>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="inputTinggalDengan" name="txtTinggalDengan" placeholder="Tinggal dengan" class="col-xs-12 col-sm-10" onkeypress="return DisableKey(event, 'alphabet')" pattern="[a-z A-Z]*$" required="" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> <small>Hubungan dengan Calon Pelamar*</small></label>
                                        <div class="col-sm-8">
                                            <input type="text" id="inputHubungan" name="txtHubungan" placeholder="Hubungan dengan Calon Pelamar" class="col-xs-12 col-sm-10" onkeypress="return DisableKey(event, 'alphabet')" pattern="[a-z A-Z]*$" required="" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Nomor Ponsel* </label>
                                        <div class="col-sm-8">
                                            <input type="text" id="inputNoPonsel" name="txtNoPonsel" placeholder="Input Nomor Ponsel" class="col-xs-12 col-sm-10" required="" minlength="11" maxlength="13" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <script>
                                        ...
                                        function umur() {
                                            ...
                                            var kelurahan = $("#inputKelurahan").val();
                                            var now = new Date();
                                            ...
                                            if (age < 18 || age > 45 || isNaN(age) == true) {
                                                notifdisable = ', Tidak Bisa Melanjutkan Registrasi !! Range Umur (18 - 45 Tahun )';
                                                $(':input[type="submit"]').prop('disabled', true);
                                            }
                                            alert(age + notifdisable);
                                        ...
                                        <div class="col-sm-8">
                                            <select class="col-xs-12 col-sm-10" name="txtAgama">
                                                ...
                                                foreach ($_getAgama as $rowAgama) :
                                                    ...
                                                    echo "<option value='$rowAgama->IDAgama,$rowAgama->Agama'>$rowAgama->Agama</option>";
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="txtnohpkerabat" name="txtnohpkerabat" placeholder="Nomor telepon" class="col-xs-12 col-sm-10" required maxlength="12" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="txtnohpkerabat">Hubungan dgn. Kerabat* </label>
                                        <div class="col-sm-8">
                                            <input type="text" id="txthubungan" name="txthubungan" placeholder="Hubungan" class="col-xs-12 col-sm-10" onkeypress="return DisableKey(event, 'alphabet')" pattern="[a-z A-Z]*$" required maxlength="20" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="inputNamaPasangan" name="txtNamaPasangan" placeholder="Input Nama Suami/ Istri" onkeypress="return DisableKey(event, 'alphabet')" pattern="[a-z A-Z]*$" class="col-xs-12 col-sm-10" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div id="listAnak" style="display: none">
                                            ...
                                            <table class="table table-bordered table-hover" id="dataTable1">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" id="inputNamaAnak" name="txtNamaAnak[]" placeholder="Nama Anak" onkeypress="return DisableKey(event, 'alphabet')" pattern="[a-z A-Z]*$" class="col-2" />
                                                        </td>
                                                        <td>
                                        ...
                                        <div class="alert alert-block alert-info">
                                            ...
                                            <p><i class="ace-icon fa fa-info"></i>&nbsp; Field tidak boleh ada yang kosong!
                                            <p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="inputNamaBapak" name="txtNamaBapak" placeholder="Input Nama Bapak Kandung" onkeypress="return DisableKey(event, 'alphabet')" pattern="[a-z A-Z]*$" class="col-xs-12 col-sm-10" required="" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Nama Ibu Kandung* </label>
                                        <div class="col-sm-8">
                                            <input type="text" id="inputNamaIbu" name="txtNamaIbu" placeholder="Input Nama Ibu Kandung" onkeypress="return DisableKey(event, 'alphabet')" pattern="[a-z A-Z]*$" class="col-xs-12 col-sm-10" required="" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div id="listSaudara" style="display:none;">
                                        <div class="col-sm-12">
                                            <input type="button" class="btn btn-xs btn-primary" value="Tambah" onclick="addRowSaudara()" />
                                            <input type="button" class="btn btn-xs btn-danger" value="Hapus" onclick="deleteRowSaudara()" />
                                        </div>
                                        <div class="clearfix"></div>
                                        <div class="col-sm-12 column table table-responsive">
                                            <table class="table table-bordered table-hover">
                                                <thead style="text-align: center;">
                                                    <tr>
                                                        ...
                                                        <th style="width: 300px;">NAMA SAUDARA KANDUNG</th>
                                                ...
                                                <tbody id="dataSaudara">
                                                    <tr>
                                                        <td><input type="checkbox" name="chk[]"></td>
                                                        <td><input type="text" name="txtNamaSaudara[]" id="inputNamaSaudara" onkeypress="return DisableKey(event, 'alphabet')" pattern="[a-z A-Z]*$" class="form-control input-sm"></td>
                                                        <td><select class="col-xs-12 col-sm-10 form-control input-sm" name="txtJekelSaudara[]" id="inputJekelSaudara">
                                                                <option value=""> --pilih</option>
                                                                <option value="1">L</option>
                                                                <option value="0">P</option>
                                                            </select></td>
                                                        <td><input type="number" name="txtUmurSaudara[]" id="inputUmurSaudara" class="form-control input-sm"></td>
                                                        <td><input type="text" name="txtPekerjaanSaudara[]" id="inputPekerjaanSaudara" class="form-control input-sm"></td>
                                                        <td><input type="text" name="txtPrusahaanSaudara[]" id="inputPrusahaanSaudara" class="form-control input-sm"></td>
                                                        <td><input type="text" name="txtJabatanSaudara[]" id="inputJabatanSaudara" class="form-control input-sm"></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                        ...
                                        <div class="alert alert-block alert-danger">
                                            ...
                                            <p><i class="ace-icon fa fa-info"></i>&nbsp; Field tibak boleh ada yang kosong!
                                            <p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-8">
                                            <select class="col-xs-12 col-sm-10" id="inputPendidikan" name="txtPendidikan" onchange="PendidikanChange(this.value);" required="">
                                                ...
                                                foreach ($_getPendidikan as $rowPendidikan) :
                                                    echo "<option value ='$rowPendidikan->Pendidikan'>$rowPendidikan->Pendidikan</option>";
                                                endforeach;
                                                ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-sm-8">
                                            <select class="col-xs-12 col-sm-10" id="inputJurusan" name="txtJurusan">
                                                ...
                                                foreach ($_getJurusan as $rowJurusan) :
                                                    echo "<option value'" . strtoupper($rowJurusan->Jurusan) . "'>" . strtoupper($rowJurusan->Jurusan) . "</option>";
                                                endforeach;
                                                ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Ijazah Terakhir </label>
                                        <div class="col-sm-8">
                                            <input type="text" id="inputIjsTerakhir" name="txtIjsTerakhir" placeholder="Input Ijazah Terakhir" class="col-xs-12 col-sm-10">
                                        </div>
                                    </div>

                                    <div class="clearfix"></div>
                                    <div class="alert alert-block alert-danger warning-pendidikan" style="display:none;">
                                        <button type="button" class="close" data-dismiss="alert">
                                            <i class="ace-icon fa fa-times"></i>
                                        </button>
                                        <p><i class="ace-icon fa fa-info"></i>&nbsp; Selain non pendidikan, Riwayat pendidikan harus diisi dengan lengkap!
                                        <p>
                                    </div>
                                </div>
                                ...
                                <div id="listPendidikan">
                                    <div class="col-sm-12">
                                        <input type="button" class="btn btn-xs btn-primary" value="Tambah" onclick="addRowPendidikan()" />
                                        <input type="button" class="btn btn-xs btn-danger" value="Hapus" onclick="deleteRowPendidikan()" />
                                    </div>
                                    <div class="clearfix"></div>
                                    <div class="col-sm-12 column table table-responsive">
                                        <table class="table table-bordered table-hover">
                                            <thead style="text-align: center;">
                                                <tr>
                                                    <th style="width: 10px;">#</th>
                                                    <th style="width: 100px;">TINGKAT<br>(SD s/d S2)</th>
                                                    <th style="width: 300px;">NAMA SEKOLAH / TEMPAT </th>
                                                    <th style="width: 150px;">JURUSAN</th>
                                                    <th style="width: 100px;">Tahun<br>Masuk</th>
                                                    <th style="width: 100px;">Tahun<br>Keluar</th>
                                            ...
                                            <tbody id="dataPendidikan">
                                                <tr>
                                                    <td><input type="checkbox" name="chk[]"></td>
                                                    <td><select class="col-xs-12 col-sm-10 inputTingkatanPendidikan select2" id="inputTingkatanPendidikan" name="txtTingkatanPendidikan[]" required="">
                                                            <option value=""> -- Silahkan pilih Pendidikan Terakhir</option>
                                                            <?php
                                                            foreach ($_getPendidikan as $rowPendidikan) :
                                                                echo "<option value ='$rowPendidikan->Pendidikan'>$rowPendidikan->Pendidikan</option>";
                                                    ...
                                                    <td><input type="text" name="txtNmSekolahPendidikan[]" id="inputNmSekolahPendidikan" class="form-control input-sm"></td>
                                                    <td><select class="col-xs-12 col-sm-10 form-control input-sm inputJurusanPendidikan" name="txtJurusanPendidikan[]" id="inputJurusanPendidikan" style="display:none;">
                                                            <option value=""> -- Silahkan pilih Jurusan</option>
                                                            <?php foreach ($_getJurusan as $rowJurusan) { ?>
                                                                <option value="<?= $rowJurusan->JurusanID ?>"><?= $rowJurusan->Jurusan ?></option>
                                                            <?php } ?>
                                                        </select></td>
                                                    <td><input type="text" name="txtThnMasukPendidikan[]" id="inputThnMasukPendidikan" class="form-control input-sm" maxlength="4"></td>
                                                    <td><input type="text" name="txtThnLulusPendidikan[]" id="inputThnLulusPendidikan" class="form-control input-sm" maxlength="4"></td>
                                                    <td><input type="text" name="txtLulusPendidikan[]" id="inputLulusPendidikan" class="form-control input-sm" maxlength="4"></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Apakah Sudah Vaksin ?* </label>
                                    <div class="col-sm-8">
                                        <div class="radio">
                                            <label>
                                                <input name="txtVaksin" type="radio" class="ace vaksinasi" value="SUDAH" required="" onClick="DisabledInputVaksin(this.value, 'inputJenisVaksin', 'inputTanggalVaksin','inputTanggalVaksin2','inputTanggalVaksin3');" />
                                                <span class="lbl"> SUDAH</span>
                                            </label>
                                        </div>
                                        <div class="radio">
                                            <label>
                                                <input name="txtVaksin" type="radio" class="ace vaksinasi" checked value="BELUM" onClick="DisabledInputVaksin(this.value, 'inputJenisVaksin', 'inputTanggalVaksin','inputTanggalVaksin2','inputTanggalVaksin3');" />
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Jenis Vaksin ?* </label>
                                    <div class="col-sm-8">
                                        <input type="text" id="inputJenisVaksin" name="txtJenisVaksin" placeholder="Jika SUDAH, Jenis Vaksin?" class="col-xs-12 col-sm-2" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label no-padding-right" for="form-field-1">Vaksin 1*</label>
                                    <div class="col-sm-8">
                                        <span class="input-icon">
                                            <input type="date" id="inputTanggalVaksin" name="txtTanggalVaksin" placeholder="Jika SUDAH, Tanggal Vaksinasi?" class="col-xs-12 form-control" />
                                            <i class="ace-icon fa fa-calendar green"></i>
                                        </span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label no-padding-right" for="form-field-1">Vaksin 2</label>
                                    <div class="col-sm-8">
                                        <span class="input-icon">
                                            <input type="date" id="inputTanggalVaksin2" name="txtTanggalVaksin2" placeholder="Jika SUDAH, Tanggal Vaksinasi?" class="col-xs-12 form-control" />
                                            <i class="ace-icon fa fa-calendar green"></i>
                                        </span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label no-padding-right" for="form-field-1">Vaksin 3</label>
                                    <div class="col-sm-8">
                                        <span class="input-icon">
                                            <input type="date" id="inputTanggalVaksin3" name="txtTanggalVaksin3" placeholder="Jika SUDAH, Tanggal Vaksinasi?" class="col-xs-12 form-control" />
                                            <i class="ace-icon fa fa-calendar green"></i>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="inputAhliWaris" maxlength='99' name="txtAhliWaris" placeholder="Input Nama Ahli Waris" class="col-xs-12 col-sm-10" required="">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="inputHubunganAhliWaris" maxlength='99' name="txtHubunganAhliWaris" placeholder="Input Hubungan Ahli Waris" class="col-xs-12 col-sm-10" required="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label no-padding-right" for="txtnohpkerabat">Nomor HP Ahli Waris* </label>
                                    <div class="col-sm-8">
                                        <input type="text" id="txtnohpkerabatAhliWaris" name="txtnohpkerabatAhliWaris" placeholder="Nomor telepon Ahli Waris" class="col-xs-12 col-sm-10" required maxlength="20" required="">
                                    </div>
                                </div>
                                <h4 class="header smaller lighter green">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label no-padding-right" for="form-field-1">wajib diisi*</label>
                                    <div class="input-group col-sm-8">
                                        <span class="input-group-addon"><i class="fa fa-envelope light-red bigger-120"></i></span>
                                        <input type="text" id="inputgmail" name="txtgmail" placeholder="Please Input Your E-Mail" class=" form-controlcol-xs-12 col-sm-10" required />
                                        </span>
                                    </div>
                                </div>
...
<div id="MyModal" class="modal fade bs-modal-lg" role="dialog" tabindex="-1" data-backdrop="static" data-keyboard="false" aria-hidden="true" data-width="75%">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                <h2>Verifikasi TK Bermasalah</h2>
                <h5><strong>[ Verifikasi ini bertujuan untuk memastikan Calon TK tidak termasuk ke dalam TK Bermasalah ]</strong></h5>
                <hr>
                <div class="row">
                    <div class="form-group hide">
                        <label class="col-sm-2 control-label no-padding-right"> NO. KTP </label>
                        <div class="col-sm-8">
                            <input type="text" id="cekKtp" name="cekKtp" placeholder="Input No. KTP" class="col-xs-12 col-sm-10" minlength="16" maxlength="16" />
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="cekNama" name="cekNama" placeholder="Input Nama Lengkap" class="col-xs-12 col-sm-10 cekNama" onkeypress="return DisableKey(event, 'alphabet')" pattern="[a-z A-Z]*$" />
                        </div>
                    </div>
                </div><br>
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="cekIbu" name="cekIbu" placeholder="Input Nama Lengkap" class="col-xs-12 col-sm-10" onkeypress="return DisableKey(event, 'alphabet')" pattern="[a-z A-Z]*$" />
                        </div>
                    </div>
                </div><br>
                <div class="row">
                    <div class="form-group text-right">
                        <div class="col-sm-9">
                            <button type="button" id="cekTK" class="btn btn-warning btn-block">Cek</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-footer">
                <button type="button" data-dismiss="modal" class="btn btn-default hide">NEXT</button>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // Mengambil elemen select dan txtFileKTP
        var selectPerusahaan = document.getElementById('inputPerusahaan');
        var inputKTP = document.getElementById('pdfUpload'); // Merujuk ke elemen input dengan ID 'pdfUpload'

        // Fungsi untuk mengatur required pada txtFileKTP
        function updateKTPRequired() {
            if (selectPerusahaan.value === 'PT PULAU SAMBU') {
                inputKTP.required = false;
            } else {
                inputKTP.required = true;
            }
        }

        // Menambahkan event listener untuk perubahan pada select
        selectPerusahaan.addEventListener('change', updateKTPRequired);

        // Memanggil fungsi saat pertama kali dimuat
...
<script language="javascript">
    $(document).ready(function() {
        ...
        if (userId !== 'riyan') {
            ...
            $('#MyModal').modal('show');
            var val_vaksinasi = $("input[name='txtVaksin']:checked").val();
            var val_pendidikan = $("#inputPendidikan").val();
            DisabledInputVaksin(val_vaksinasi, 'inputJenisVaksin', 'inputTanggalVaksin', 'inputTanggalVaksin2', 'inputTanggalVaksin3');
            PendidikanChange(val_pendidikan);
            //$('#myModal').modal('hide');
            $(':input[type="submit"]').prop('disabled', true);
        }
    });
    ...
    $('#submit').click(function() {
        var rowCount = $('input[name ="txtNmSekolahPendidikan[]"').length;
        var pendidikan = $("#inputPendidikan option:selected").text();
        var txtRiwayat = $('input[name ="txtNmSekolahPendidikan[]"]').val();
        // console.log();
        ...
        if (pendidikan == "SMP" || pendidikan == "MTS") {
            if (rowCount < 2) {
                scrollWarning();
            }
            if (txtRiwayat == '') {
        ...
        if (pendidikan == "SMU" || pendidikan == "MAN" || pendidikan == "SMK") {
            if (rowCount < 3) {
                scrollWarning();
            }
            if (txtRiwayat == '') {
        ...
        if (pendidikan == "D1" || pendidikan == "D2" || pendidikan == "D3" || pendidikan == "D4" || pendidikan == "S1") {
            if (rowCount < 4) {
                scrollWarning();
            }
            if (txtRiwayat == '') {
    ...
    function scrollWarning() {
        $(document).scrollTo('#inputPendidikan', 1000);
        $('.warning-pendidikan').css("display", "block");
    ...
    function addRowPendidikan() {
        var table = document.getElementById('dataPendidikan');
        console.log(table);
        ...
        for (var i = 0; i < colCount; i++) {
            var newcell = row.insertCell(i);
            var oldCell = table.rows[0].cells[i];

            // Clone hanya elemen asli, skip .select2-container
            Array.from(oldCell.childNodes).forEach(function(node) {
                // Skip elemen Select2 container yang digenerate otomatis
                ...
                // Bersihkan sisa atribut Select2 jika elemen SELECT
                if (cloned.tagName === 'SELECT') {
                    $(cloned).removeClass('select2-hidden-accessible');
                    $(cloned).removeAttr('data-select2-id');
            ...
            // Reset nilai berdasarkan tipe childNode pertama yang bukan Select2
            var firstInput = newcell.querySelector('input, select, textarea');
            if (firstInput) {
                switch (firstInput.type) {
                    ...
                    case "checkbox":
                        ...
                        break;
                    case "select-one":
                        firstInput.selectedIndex = 0;
                        break;
                }
            }

            // Inisialisasi ulang Select2 di cell baru
            $(newcell).find('.select2').each(function () {
                $(this).select2({
            ...
            // ✅ Reset display Select2 container agar tidak hidden
            $(newcell).find('.select2-container').css('display', '');
            $(newcell).find('#s2id_inputJurusanPendidikan').css('display', 'none');
        }
    }

    function deleteRowPendidikan() {
        try {
            var table = document.getElementById('dataPendidikan');
            var rowCount = table.rows.length;
    ...
    $('#inputJumlahSaudara').keyup(function() {
        var jml = $(this).val();
    ...
    function addRowSaudara() {
        var table = document.getElementById('dataSaudara');
        var rowCount = table.rows.length;
        var row = table.insertRow(rowCount);
        var colCount = table.rows[0].cells.length;
...
<script language="JavaScript">
    ...
    function PendidikanChange(objvalue) {
        ...
        if (objvalue === "D1" || objvalue === "D2" || objvalue === "D3" || objvalue === "D4" || objvalue === "S1" || objvalue === "S2" || objvalue === "S3") {
            ...
            document.getElementById('inputShcool').readOnly = true;
            document.getElementById('inputUniversitas').style.display = "none";
        } else {
            document.getElementById('inputSekolah').style.display = "block";
            document.getElementById('inputShcool').readOnly = false;
            document.getElementById('inputUniversitas').style.display = "none";
        }
    }
    ...
    function DisabledInputVaksin(object, input_id, input_id2, input_id3, input_id4) {
        var el = document.getElementById(input_id);
        var tgl = document.getElementById(input_id2);
        var tgl2 = document.getElementById(input_id3);
        var tgl3 = document.getElementById(input_id4);
    ...
    $(document).on('change', '.inputTingkatanPendidikan', function(){
        ...
        if (pd == 'D1' || pd == 'D2' || pd == 'D3' || pd == 'D4' || pd == 'S1' || pd == 'S2' || pd == 'S3' || pd == 'SMA' || pd == 'SMK' || pd == 'MAN' || pd == 'SMU') {
            that.closest('tr').find('.inputJurusanPendidikan').css("display", "block");
        } else {
            that.closest('tr').find('.inputJurusanPendidikan').css("display", "none");
...
<script>
    ...
    function DisableKey(e, type) {
        ...
        // decimal
        if (type == 'alphabet') {
            // tombol Backspace, Tap, titik, slash, tanda hubung, dan spcae diperbolehkan
            if (desimal == 8 || desimal == 9 || desimal == 32 || desimal == 45 || desimal == 46 || desimal == 96) {
                return true;
            } else {
                // jika bukan huruf
    ...
    $('#cekTK').click(function() {
        // var cari = {
        //     nama: $("#cekNama").val(),
        //     ibu: $("#cekIbu").val()
        // };

        let nama = $("#cekNama").val();
        let ibu = $("#cekIbu").val();

        if (nama != '' && ibu != '') {
            console.log('kamu memasukkan nama ' + nama + ' dan ibu ' + ibu);

            $.ajax({
                type: "POST",
                url: "<?php echo site_url('registrasi/cekTK') ?>",
                data: {
                    nama: nama,
                    ibu: ibu
                },
                ...
                success: function(msg) {
                    console.log(msg);
                    if (msg == '') {
                        alert('Nama tidak ada di dalam TK Bermasalah, silahkan melanjutkan registrasi.!');
                        $('#MyModal').modal('hide');
                        alert('PASTIKAN ANDA MENGINPUT DATA CALON TK DENGAN BENAR, JIKA TERJADI KESALAHAN PENGINPUTAN MAKA DATA TIDAK BISA DI EDIT DAN DATA TIDAK DAPAT DI PROSES LEBIH LANJUT !');
                    } else {

                        $('#tbl_karyawan').html(msg);
                        $('.modal-footer').append('<div class="alert alert-danger text-left"><strong>Warning! </strong>Calon TK a/n ' + $("#cekNama").val() + ' tidak lulus sceening dan Registrasi tidak bisa dilanjutkan.</div>');
                    }
                }
            });
        } else {
            alert('Kolom Nama Lengkap dan Nama Ibu tidak boleh kosong !!');
        }
    });
</script>