                                        ...
                                        <div class="col-sm-12 column table table-responsive">
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <tbody id="dataSaudara">
                                                    <tr>
                                                        <td><input type="checkbox" name="chk[]"></td>
                                                        <td><input type="text" name="txtNamaSaudara[]" id="inputNamaSaudara" class="form-control input-sm"></td>
                                    ...
                                    <div class="col-sm-12 column table table-responsive">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody id="dataPendidikan">
                                                <tr>
                                                    <td><input type="checkbox" name="chk[]"></td>
                                                    <td><select class="col-xs-12 col-sm-10" id="inputTingkatanPendidikan" name="txtTingkatanPendidikan[]" onchange="PendidikanChange(this.value);" required="">
                                                            <option value=""> -- Silahkan pilih Pendidikan Terakhir</option>
                                                            <?php
                                                            foreach ($_getPendidikan as $rowPendidikan) :
                                                                echo "<option value ='$rowPendidikan->Pendidikan'>$rowPendidikan->Pendidikan</option>";
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h2>Verifikasi TK Bermasalah (Blacklist)</h2>
                <h5><strong>[ Verifikasi ini bertujuan untuk memastikan Calon TK tidak termasuk ke dalam Blacklist ]</strong></h5>
                <hr>
                <div class="row">
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="cekNama" name="cekNama" placeholder="Input Nama Lengkap" class="col-xs-12 col-sm-10" pattern="[a-z A-Z]*$" />
                        </div>
                    </div>
                </div><br>
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="cekIbu" name="cekIbu" placeholder="Input Nama Lengkap" class="col-xs-12 col-sm-10" pattern="[a-z A-Z]*$" />
                        </div>
                    </div>
                </div><br>
                <div class="row">
...
<script>
    ...
    $('#cekTK').click(function() {
        ...
        $.ajax({
            ...
            success: function(msg) {
                if (msg == '') {
                    alert('Nama tidak ada di dalam Blacklist, silahkan melanjutkan registrasi.!');
                    $('#MyModal').modal('hide');
                } else {
                    $('#tbl_karyawan').html(msg);
                    $('.modal-footer').append('<div class="alert alert-danger text-left"><strong>Warning! </strong>Calon TK a/n ' +
                        $("#cekNama").val() + ' ada di dalam Blacklist dan Registrasi tidak bisa dilanjutkan.</div>');
                }
            }
        });
    });
