...
<div class="row">
  <div class="col-xs-12">
    ...
    <!-- Design Disini -->
    <form id="formRegistrasi" class="form-horizontal" action="<?php echo site_url('registrasi/simpanReg_dev'); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-8">
                      <select class="col-xs-12 col-sm-10" id="inputJurusan" name="txtJurusan">
                        ...
                        foreach ($_getJurusan as $rowJurusan) :
                          echo "<option value'$rowJurusan->Jurusan'>$rowJurusan->Jurusan</option>";
                        endforeach;
                        ?>
                      </select>
                    </div>
                  ...
                  <div class="col-sm-12 column table table-responsive">
                    <table class="table table-bordered table-hover">
                      ...
                      <tbody id="dataPendidikan">
                        <tr>
                          <td><input type="checkbox" name="chk[]"></td>
                          <td><select class="col-xs-12 col-sm-10" id="inputTingkatanPendidikan" name="txtTingkatanPendidikan[]" onchange="PendidikanChange2(this.value);" required="">
                              <option value=""> -- Silahkan pilih Pendidikan Terakhir</option>
                              <?php
                              foreach ($_getPendidikan as $rowPendidikan) :
                                echo "<option value ='$rowPendidikan->Pendidikan'>$rowPendidikan->Pendidikan</option>";
                          ...
                          <td><select class="col-xs-12 col-sm-10 form-control input-sm" name="txtJurusanPendidikan[]" id="inputJurusanPendidikan" style="display:none;">
                              <option value=""> -- Silahkan pilih Jurusan</option>
...
<script language="JavaScript">
  ...
  $('#inputTingkatanPendidikan').change(function() {
    var pd = $('#inputTingkatanPendidikan').val();
    if (pd == 'D1' || pd == 'D2' || pd == 'D3' || pd == 'D4' || pd == 'S1' || pd == 'S2' || pd == 'S3' || pd == 'SMA' || pd == 'SMK' || pd == 'MAN' || pd == 'SMU') {
      $('#inputJurusanPendidikan').css("display", "block");
    } else {
      $('#inputJurusanPendidikan').css("display", "none");
