...
<?php echo $errormsg;?>
<?php $att = array('id'=>'formUpload', 'class'=>'form-horizontal', 'role'=>'form');
echo form_open_multipart('registrasi/uploadAksi', $att);?>
    <fieldset>
            ...
            <div class="col-xs-12">
                <div class="widget-box">
                    <div class="widget-header">
                        <h4 class="widget-title">Upload Foto atas nama <?php echo $namapelamar;?></h4>
                    ...
                    <div class="widget-body">
                        <div class="widget-main">
                            <div class="alert alert-block alert-info">
                                Format data yang diizinkan untuk diupload hanya Photo/Gambar (jpeg|jpg|png|gif), dan Maximal Berkas 900 KB.
                            </div>
                            <input type="hidden" id="inputHeaderID" name="txtHeaderID" value="<?php echo $hdrid;?>">
                            <input type="hidden" id="inputNamaPelamar" name="txtNamaPelamar" value="<?php echo $namapelamar;?>">
                            <div class="clearfix"></br></div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Pilih Foto</label>
                                <div class="col-xs-5">
