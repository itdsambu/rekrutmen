...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="alert alert-danger">
            <strong>Penting!</strong> Modul ini hanya digunakan apabila ada kesamaan data dengan data yang sudah ada,
            dan tersaring dalam sistem!!
        </div>
        <!-- Design Disini -->
        <fieldset>
            <div class="row">
                <div class="col-xs-8">
                    <div class="widget-box">
                        <form id="formRegistrasi" class="form-horizontal" action="<?php echo site_url('registrasi/simpanRegByPass'); ?>" method="POST">
                            ...
                            <div class="widget-body">
                                <div class="widget-main">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="inputNoKTP" name="txtNoKTP" placeholder="Input No. KTP" class="col-xs-12 col-sm-10" required="" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <script>
                                        ...
                                        function umur() {
                                            ...
                                            if (age < 18 || age > 65 || isNaN(age) == true) {
                                                notifdisable = ', Tidak Bisa Melanjutkan Registrasi !! Range Umur (18 - 65 Tahun )';
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="inputNamaPasangan" name="txtNamaPasangan" placeholder="Input Nama Suami/ Istri" class="col-xs-12 col-sm-10" disabled="" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <span class="input-icon">
                                                <input type="text" id="inputTglLahirPasangan" name="txtTglLahirPasangan" placeholder="Input Tanggal Lahir" disabled="" />
                                                <i class="ace-icon fa fa-calendar green"></i>
                                            </span> Format (dd-mm-yyyy)
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="inputPekerjaanPasangan" name="txtPekerjaanPasangan" placeholder="Input Pekerajaan Suami/ Istri" class="col-xs-12 col-sm-10" disabled="" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Alamat Suami/ Istri </label>
                                        <div class="col-sm-8">
                                            <textarea class="col-xs-12 col-sm-10" id="inputAlamatPasangan" name="txtAlamatPasangan" placeholder="Input Alamat Suami/ Istri" disabled=""></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="col-xs-12 col-sm-10" id="inputJurusan" name="txtJurusan" disabled="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="inputBagian" name="txtBagian" placeholder="Jika Ya, Di Bagian/ Department mana?" class="col-xs-12 col-sm-10" disabled="" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <input type="text" id="inputCacatApa" name="txtCacatApa" placeholder="Jika Ya, Cacat apa?" class="col-xs-12 col-sm-10" disabled="" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <input type="text" id="inputPenyakit" name="txtPenyakit" placeholder="Jika Ya, Penyakit apa?" class="col-xs-12 col-sm-10" disabled="" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <input type="text" id="inputKriminal" name="txtKriminal" placeholder="Jika IY, Tindakan Kriminal Apa yang Dilakukan?" class="col-xs-12 col-sm-10" disabled="" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <input type="text" id="inputTatoDimana" name="txtTatoDimana" placeholder="Jika IY, Tato dibagian apa?" class="col-xs-12 col-sm-10" disabled="" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                ...
                <?php if ($this->session->userdata('dept') == 'HRD' || $this->session->userdata('dept') == 'ITD') { ?>
                    <div class="col-xs-4">
                        <div class="widget-box">
                            <div class="widget-header">
                                <h3 class="widget-title">Import data tenaga kerja</h3>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control datepick" id="dateFilter" name="dateFilter" placeholder="dd-mm-yyyy" autocomplete="off">
                                                            <!-- <input type="text" id="dateFilter" name="dateFilter" placeholder="Filter Tanggal" required="" aria-required="true" aria-invalid="false" aria-describedby="dateFilter-error" class="valid"> -->
                                                        </div>
                                                        <!-- <script>
                                                        $(function() {
                                                            $('#dateFilter').datepick({
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="input-group">
                                                            <button id="exportExcel" class="btn btn-primary btn-block equal-height">Export Excel</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                <br>

                                                <table id="list-imported-tk-table" class="toExcel table table-striped table-bordered table-hover">
                                                    <thead>
                                                        <tr>
                                                            <th style="width: 30%;">Header ID</th>
                                                            <th>Nama</th>
                                                            <th>Upload By</th>
                                                        </tr>
                                                    </thead>
...
<script language="JavaScript">
    ...
    function PendidikanChange(objvalue) {
        ...
        } else if (objvalue === "" || objvalue === "TIDAK SEKOLAH") {
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#importForm").submit(function(e) {
            ...
            $.ajax({
                url: "<?= base_url('registrasi/importExcel') ?>",
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
        ...
        $('#dateFilter').on('input', function() {
            ...
            // Hanya izinkan angka & batasi maksimal 8 digit
            input = input.replace(/[^0-9]/g, '').substring(0, 8);

            // Jika sudah 8 digit, ubah format menjadi dd-mm-yyyy
            if (input.length === 8) {
        ...
        var table = $("#list-imported-tk-table").DataTable({
            processing: false,
            responsive: true,
            order: [],
            serverSide: true,
    ...
    $('#exportExcel').click(function() {
        ...
        var dateFilter = $('#dateFilter').val(); // Ambil nilai dateFilter

        // Redirect ke URL export dengan parameter tanggal (opsional)
        var url = '<?= base_url("registrasi/export_excel") ?>';
        if (dateFilter !== '') {
            url += '?dateFilter=' + dateFilter;
        }
        window.open(url, '_blank');
    });
    // toastr.error("Terjadi kesalahan saat mengupload.");
</script>