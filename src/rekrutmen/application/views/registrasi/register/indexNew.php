...
<script>
    document.getElementById('uploadForm').addEventListener('submit', function(event) {
        ...
        // Cek apakah file ada
        if (file) {
            // Cek ukuran file (5 MB dalam byte)
            if (file.size > 5242880) { // 5 MB = 5 * 1024 * 1024 Byte
                document.getElementById('error-message').innerHTML = 'Ukuran file tidak boleh lebih dari 5 MB.';
            ...
            document.getElementById('error-message').innerHTML = 'Silakan pilih file PDF.';
            event.preventDefault(); // Mencegah form dari submit
        }
    });
</script>
