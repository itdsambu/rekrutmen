...
<?php echo form_open_multipart('datakaryawan/do_upload', array('id' => 'formUpload1','class'=>'form-horizontal')); ?>
        <div class="row">
            <div class="col-xs-12">
                <div class="widget-box">
                    <div class="widget-header">
                        <h4 class="widget-title">Upload KTP atas nama <?php echo $namatk;?></h4>
                    ...
                    <div class="widget-body">
                        <div class="widget-main">
                            ...
                            <input type="hidden" id="inputHeaderID" name="txtHeaderID" value="<?php echo $hdrid;?>" readonly>
                            <input type="hidden" id="inputFixNo" name="txtFixNo" value="<?php echo $fixno;?>" readonly>
                            <input type="hidden" id="inputNamaTK" name="txtNamaTK" value="<?php echo $namatk;?>" readonly>
                            <div class="clearfix"></br></div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Pilih File KTP</label>
                                <div class="col-xs-5">
                                    <input name="userfile2" type="file" id="id-input-file-ktp" accept=".pdf">
...
<script type="text/javascript">
    jQuery(function($) {
        $('#id-input-file-ktp').ace_file_input({
            no_file:'Silakan pilih KTP dari komputer dengan menekan tombol PILIH (format file PDF !)',
            btn_choose:'Pilih',
            btn_change:'Change',
            droppable:false,
            onchange:null,
