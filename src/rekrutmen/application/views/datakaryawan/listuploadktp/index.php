                                        ...
                                        <div class="col-sm-8">
                                            <select name="txtStatusKtp" id="inputStatusKtp" class="form-control input-sm">
                                                <option value="0" <?php if ($_selected == 0) {
                                                                        echo 'selected';
                                                                    } ?>>All Data Tenaga Kerja</option>
                                                <option value="1" <?php if ($_selected == 1) {
                                                                        echo 'selected';
                                                                    } ?>>Data Tenaga Kerja Registered</option>
                                                <option value="2" <?php if ($_selected == 2) {
                                                                        echo 'selected';
                                                                    } ?>>Data Tenaga Kerja Unregistered</option>
                                                option
                                            </select>
                                        </div>
                                        <script>
                                        ...
                                        <div class="col-sm-8">
                                            <select name="txtDept" id="inputDept" class="form-control input-sm">
                                                ...
                                                <?php foreach ($all_dept as $dept) { ?>
                                                    <option value="<?php echo $dept->IDDept; ?>" <?php if ($_selectedDept == $dept->IDDept) {
                                                                                                        echo 'selected';
                                            ...
                                            <tr class="info" data-id="<?php echo $row->HeaderID ?>">
                                                ...
                                                <td class="text-left excludeExport">
                                                    <div class="btn-group">
                                                        ...
                                                        <a title="Upload KTP" data-rel="tooltip" href="<?php echo site_url('datakaryawan/doUploadKTP') . "?id=" . $row->HeaderID . "&nama=" . $row->nama . "&fixno=" . $row->FixNo; ?>" class="upload_ktp btn btn-minier btn-round btn-success">
