                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select name="txtStatusKtp" id="inputStatusKtp" class="form-control input-sm">
                                        <option value="0" <?php if ($_selected == 0) { echo 'selected';} ?>>All Data Karyawan</option>
                                        <option value="1" <?php if ($_selected == 1) { echo 'selected';} ?>>Data Karyawan Registered</option>
                                        <option value="2" <?php if ($_selected == 2) { echo 'selected';} ?>>Data Karyawan Unregistered</option>
                                        option
                                    </select>
                                </div>
                                <script>
                                ...
                                <div class="col-sm-8">
                                    <select name="txtDept" id="inputDept" class="form-control input-sm">
                                        ...
                                        <?php foreach ($all_dept as $dept) { ?>
                                            <option value="<?php echo $dept->deptabbr; ?>" <?php if ($_selectedDept == $dept->deptabbr) { echo 'selected';} ?>><?php echo $dept->deptabbr; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                                        ...
                                        <td class="text-left excludeExport">
                                            <div class="btn-group">
                                                ...
                                                <a title="Upload KTP" data-rel="tooltip" href="<?php echo site_url
                                                    ('datakaryawan/doUploadKaryawanKTP')."?id=".$row->HeaderID."&nama=".$row->nama."&regno=".$row->regno; ?>" class="upload_ktp btn btn-minier btn-round btn-success">
...
<script src="http://192.168.3.5/rekrutmen/assets/table2excel.js"></script>
