                                    ...
                                    <label class='container text-left'>
                                        <?php if ($key->IDObjectif == $jb->IDBenar) {
                                            ...
                                            <?php
                                                ...
                                                <input type="radio" id="objectif_id<?php echo $key->IDSoal; ?>" name="objectif<?php echo $key->IDSoal ?>" class="md-radiobtn txtobjectif_<?= $jb->IDObjectif; ?>" value="<?php echo $key->IDObjectif; ?>" disabled>
                                                <input type="hidden" name="txtDetailID" id="detailid" class="form-control detail_id_<?= $jb->DetailID; ?>" value="<?php echo $row->DetailID ?>">
                                                <span class='checkmark'></span>
                                                <span style="color: lightgreen;">
                                                    <?php if ($key->Link == NULL) {
                                                        echo $key->Objectif;
