            ...
            html += `
                <tr class="rowItem" id="itemID_${arrSearchItem[x].ItemID}">
                    ...
                    <td class="text-center col-lg-2 col-sm-2 col-xs-2">
                        <input type="text" name="txtHarga[]" value="${tandaPemisahTitik(arrSearchItem[x].Harga)}" id="harga_${arrSearchItem[x].ItemID}" class="form-control classHarga" onkeypress="return getNumber(event);" onkeyup="hitungTotal(${arrSearchItem[x].ItemID});inputanFormat(this.value, this.id);" readonly=""/>
                    </td>
                    <td class="text-center col-lg-1 col-sm-1 col-xs-1">
                        <input type="text" name="txtQuantity[]" value="1" id="quantity_${arrSearchItem[x].ItemID}" class="form-control classQuantity" onkeypress="this.value = this.value.replace(/,/g, '.')" onkeyup="hitungTotal(${arrSearchItem[x].ItemID});">
                    </td>
                    <td class="text-center col-lg-1 col-sm-1 col-xs-1">
                    ...
                    if(statusItemID == 0){
                        ...
                        html += `
                            <tr class="rowItem" id="itemID_${response[0].ItemID}">
                                ...
                                <td class="text-center col-lg-2 col-sm-2 col-xs-2">
                                    <input type="text" name="txtHarga[]" value="${response[0].Harga}" id="harga_${response[0].ItemID}" class="form-control classHarga" onkeypress="return getNumber(event);" onkeyup="hitungTotal(${response[0].ItemID});inputanFormat(this.value, this.id);" readonly=""/>
                                </td>
                                <td class="text-center col-lg-1 col-sm-1 col-xs-1">
                                    <input type="text" name="txtQuantity[]" value="1" id="quantity_${response[0].ItemID}" class="form-control classQuantity" onkeypress="this.value = this.value.replace(/,/g, '.')"  onkeyup="hitungTotal(${response[0].ItemID});">
                                </td>
                                <td class="text-center col-lg-1 col-sm-1 col-xs-1">
