...
<div class="row">
    <div class="col-lg-12">
        <div class="widget-box">
            ...
            <form class="form-horizontal" role="form" method="POST" action="<?php echo base_url('PotonganBon/update_mst_kategori');?>">
            <div class="widget-body">
                <div class="widget-main">
                    <div class="row">
                        <?php foreach($_getDataKategori as $get){?>
                            <input type="hidden" name="txtKategoriID" value="<?php echo $get->KategoriID?>">
                      <div class="col-lg-12">
