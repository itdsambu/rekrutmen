...
<page style="font-size: 15px; font-family: Arial;" backtop="7mm" backbottom="10mm" backleft="10mm" backright="18mm">
    ...
    <table class="tbl1" style="font-size: 9px; font-family: Arial;" backtop="7mm" backbottom="10mm" backleft="5mm" backright="5mm">
        ...
        <tr>
            ...
            <!-- <td style="width: 15%; border-right: 1;border-top: 1;border-left: 1;border-bottom: 1;text-align: center;height: 10px; font-weight: bold;">Rp.<?php echo number_format($key->HargaCicilan, 0, ",", "."); ?></td> -->
            ...
            <td style="width: 15%; border-right: 1;border-top: 1;border-left: 1;border-bottom: 1;text-align: center;height: 10px; font-weight: bold;">Rp.<?php echo number_format($total, 0, ",", "."); ?></td>
        </tr>
        <br>
        <br>
        <tr>
            ...
            <!-- <td style="width: 15%; border-right: 1;border-top: 1;height: 10px;border-bottom: 1;text-align: center;font-weight: bold;">Rp.<?php echo number_format($_getDataCicilan->Pot_Sembako + $key->HargaCicilan, 0, ",", "."); ?></td> -->
            <!-- <td style="width: 15%; border-right: 1;border-top: 1;height: 10px;border-bottom: 1;text-align: center;font-weight: bold;">Rp.<?php echo number_format($_getDataCicilan->Pot_Sembako + $_getDataCicilan->Pot_Cicilan, 0, ",", "."); ?></td> -->
            <td style="width: 15%; border-right: 1;border-top: 1;height: 10px;border-bottom: 1;text-align: center;font-weight: bold;">Rp.<?php echo number_format($_getDataCicilan->Pot_Sembako + $total, 0, ",", "."); ?></td>
        </tr>
        <tr>
            ...
            <td style="width: 15%; border-right: 1;border-top: 1;height: 10px;border-bottom: 1;text-align: center">Rp.<?php echo number_format($_getDataCicilan->Sisa_PeriodeSebelumnya_tkbaru, 0, ",", "."); ?></td>
        </tr>
        <tr>
            ...
            <td style="width: 15%; border-right: 1;border-top: 1;height: 10px;border-bottom: 1;text-align: center;font-weight: bold;">Rp.<?php echo number_format($_getDataCicilan->DiPotongPeriodeIni_Sembako + $_getDataCicilan->DiPotongPeriodeIni_Cicilan, 0, ",", "."); ?></td>
        </tr>
        <tr>
            ...
            <td style="width: 15%; border-right: 1;border-top: 1;height: 10px;border-bottom: 1;text-align: center;font-weight: bold;">
                <?php
                if (($_getDataCicilan->Pot_Sembako + $total) + $_getDataCicilan->Sisa_PeriodeSebelumnya_tkbaru - ($_getDataCicilan->DiPotongPeriodeIni_Sembako + $_getDataCicilan->DiPotongPeriodeIni_Cicilan) < 0) {
                    echo "Rp. 0";
                } else {
