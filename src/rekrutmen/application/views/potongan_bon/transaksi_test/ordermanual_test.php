...
<div class="row">
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget-box">
            ...
            <form class="form-horizontal" id="formSave" role="form" method="POST" action="<?php echo base_url('PotonganBon/simpan_trn_manual_potongan_pemborong');?>">
                    ...
                    <div class="row">
                      <div class="col-lg-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4 col-sm-4 col-xs-9" id="tblSub"></div>
                        </div>
                        <div class="form-group">
                        ...
                        <div id="otpid">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-4 col-sm-4 col-xs-9">
                                    <input type="text" name="txtNofix" class="form-control" readonly="" >
                                </div>
                            </div>
                            <div class="form-group">
...
<script type="text/javascript">
   ...
   function get_item_pemborong(){
        ...
        type: "GET",
        dataType: "html",
        url: "<?php echo base_url('PotonganBon/ajax_list_item_iyul')?>"+"/"+sub,
        success: function(msg){
              if(msg == ''){
                alert('Tidak ada data');
              } 
