                        ...
                        <table id="dataTables-issue" class="table table-bordered" style="white-space: nowrap;">
                            ...
                            <tbody>
                                ...
                                <tr data-id="<?php echo $row->DetailID;?>">
                                    ...
                                    <td><?php echo ($row->GeneralStatus == 3 ? 'Telah Terpenuhi' : ($row->GeneralStatus == 2 ? 'Di Cancel' : ($row->GeneralStatus == 1 ? 'Appoved' : 'On Progress')))?></td>
...
<script src="<?php echo base_url(); ?>assets/tableToExcel.js"></script>
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#btnExport").click(function () {
            ...
            //    , datatype: 'table'
            // });
             TableToExcel.convert(document.getElementById("dataTables-issue"), {
                name: "RekapIssuePermintaan.xlsx",
                sheet: {
                name: "Sheet1"
            }
          });
