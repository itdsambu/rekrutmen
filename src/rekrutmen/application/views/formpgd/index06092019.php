                    ...
                    <div class="col-xs-12">
                        <div class="widget-box">
                            <div class="widget-header">
                                <h4 class="widget-title">PERMOHONAN PENGUNDURAN DIRI TENAGA KERJA</h4>
                                    ...
                                    <div class="row" id="ajaxFormHeader">
                                    	<div class="col-xs-6">
                                    		...
                                    		<div class="form-group">
                                    			...
                                    			<div class="col-sm-9">
                                    				<input type="text" name="txtjabatan" id="jabatan" placeholder="JABATAN" class="form-control" readonly>
                                    			</div>
                                    		</div>
                                    	</div>
                                    	<div class="col-xs-6">
                                    		...
                                    		<div class="form-group">
                                    			...
                                    			<div class="col-sm-9">
                                    				<input type="text" name="txtalamat" id="alamat" placeholder="MESS/BLOK" class="form-control" readonly>
                                    			</div>
                                    		</div>
                                    	</div>
                                    </div>
...
<script type="text/javascript">
    $("#btnFind").click(function(){
        ...
        if(nik == ''){
            ...
            $.ajax({
                type: "POST",
                url : "<?php echo site_url('Suratpgd/ajaxtenagakerja')?>"+"/"+nik,
