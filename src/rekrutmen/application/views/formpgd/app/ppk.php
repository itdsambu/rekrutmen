            ...
            <div class="panel-body">
                ...
                <div class="col-sm-12">
                    <div class="well text-center">
                        <input type="button" id="btnApprovePPKPGD" value="Approve" name="Submit" class="btn btn-success" >
                        <input type="button" id="btnRejectPPKPGD" value="Decline" name="Submit" class="btn btn-danger" >
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    var urlApprovePPKMulti = '<?= base_url() ?>Suratpgd/approvekonfirmasikontrakPPKMulti',
        urlRejectePPKMulti = '<?= base_url() ?>Suratpgd/rejectkonfirmasikontrakPPKMulti';
</script>
<script type="text/javascript">
    ...
    $('#btnApprovePPKPGD').click(function(){
        $("#formpgd").attr('action', urlApprovePPKMulti);
        swal({
            title: "Approve data ?",
            type: "info",
    ...
    $('#btnRejectPPKPGD').click(function(){
        $("#formpgd").attr('action', urlRejectePPKMulti);
        swal({
            title: "Reject data ?",
            type: "info",
            showCancelButton: true,
