    ...
    <div class="col-lg-12">
        <div class="widget-box">
            <div class="widget-header">
                <h4 class="widget-title">BELBIN TEST</h4>
            ...
            <form class="form-horizontal" role="form" method="POST" action="<?php echo base_url('PsychologicalAssisment/simpanDataBelbin')?>">
            ...
            <script>
                $(document).ready(function(){
                    $('#Belbintest').dataTable();
                    $('#Belbintest').click(function(){
                    $('.panel-heading').hide();
                    $('.panel-body').hide();
                    });
                });
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div style="padding: 5px;"></div>
                        <table class="table table-hover table-striped table table-striped table-hover table-bordered" id="Belbintest">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header"> <!--style="background-color: #008cba">-->                
                ...
                <h4 class="modal-title">User Belbin Test</h4>
            </div>
            <div class="modal-body">
                <div id="lihat_detail" class="well">
                    <div class="form-group">
                        ...
                        <button type="button" id="btnCari" class="btn btn-sm btn-success" style="background-color: #2D8B4D !important; border-color: #2D8B4D;" onclick="callAjax();"> 
...
<script type="text/javascript">
    ...
    $("#btnFind").click(function(){
        ...
        if(id != ''){
            $.ajax({
                type: "POST",
                url : "<?php echo site_url('PsychologicalAssisment/getNamaBelbin')?>",
                data: {
                    'id' : id
                },
                success: function(msg){
