...
<div class="page-header">
    <h1>
        ...
        <small>
            ...
            Approval Request by Personalia
        </small>
    </h1>
</div><!-- /.page-header -->
...
echo form_open('approval/multiApprovalPSN', $att);
?>
<div class="row">
    <div class="col-xs-12">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Approval PSN by <strong class="green"><?php echo $this->session->userdata('username'); ?></strong></h4>
            </div>
