<?php if($_cekDdata >= 0){?>
	<?php foreach($_getDdata as $row){?>
	    <div class="form-group">
	        ...
	        <div class="col-sm-2">
                <input type="hidden" name="txtpendidikan" id="pendidikan" placeholder="Satus Pendidikan" value="<?php echo $row->StatusPendidikan?>" readonly/>
                <input type="text" name="txtstspendidikan" id="stspendidikan" class="form-control input-sm" placeholder="Satus Pendidikan" value="<?php if($row->StatusPendidikan == 0){echo 'Non Pendidikan';}else{echo 'Pendidikan';}?>" readonly/>
            </div>
	        <div class="col-sm-2">
