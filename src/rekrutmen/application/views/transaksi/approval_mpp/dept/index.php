        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <i class="fa fa-list"></i> Approval MPP Dept
...
<script>
    ...
    var table = $('#tblPerubahanMPP').DataTable({
        ...
        order: [],
        ajax: {
            url: base_url + 'approval_mpp/show_app_dept',
            type: 'POST',
            data: function(d) {
    ...
    $("#tblPerubahanMPP").on("click", ".approval-btn", function() {
        ...
        $.ajax({
            url: "<?php echo site_url('approval_mpp/viewApprovalDept'); ?>",
            type: "POST",
            data: "kode=" + id,
            datatype: "json",
            cache: false,
    ...
    $(document).on('submit', '#approvalForm', function(e) {
        ...
        $.ajax({
            url: '<?= base_url("approval_mpp/approve_dept") ?>',
            type: 'POST',
            data: formData,
            dataType: 'json',
            success: function(res) {
    ...
    $(document).on('click', '#btnApprove', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: base_url + 'approval_mpp/approve_all_dept',
                    type: 'POST',
                    data: {
                        ids: ids
                    },
    ...
    $(document).on('click', '#btnDisapprove', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: base_url + 'approval_mpp/disapprove_all_dept',
                    type: 'POST',
                    data: {
                        ids: ids
                    },
