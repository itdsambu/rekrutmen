...
<h4 class="row header smaller lighter blue">
    <span class="col-sm-12">
        ...
        Edit Issue dengan ID <strong>#<?php foreach ($getTran as $row){ echo $row->DetailID;}?></strong>
    </span> 
</h4>
<?php 
    $att = array('class'=>'form-horizontal', 'role'=>'form');
    echo form_open('issue/doEditIssue', $att);
...
<div class="form-group">
    ...
    <div class="col-sm-8">
        <select class="form-control" id="inputPemborong" name="comboPemborong">
            ...
            <option value="PSG" <?php if($row->Pemborong == 'PSG'){ echo 'selected';}?> > PSG </option>
            <option value="ALL PEMBORONG" <?php if($row->Pemborong == 'ALL PEMBORONG'){ echo 'selected';}?> > ALL PEMBORONG </option>
        </select>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-8">
        <select class="form-control" id="inputDept" name="comboDept">
            ...
            <option value="<?php echo $rowDept->IDDept; ?>" <?php if($rowDept->IDDept == $row->DeptID){echo 'selected';}?> >
...
<div class="form-group" id="divPekerjaan" style="display: <?php echo $disKerja;?>;" >
    ...
    <div id="bagian" class="col-sm-8">
        <select class="form-control" id="inputTransaksi" name="comboTansaksi">
            <option value=""> -- Pilih </option>
            <option value="1"  <?php if($row->PekerjaanID == 1){ echo 'selected';}?> > HARIAN </option>
    ...
    <div class="col-sm-8">
        <select class="form-control" id="inputJabatan" name="comboJabatan">
            ...
            <?php foreach ($getJbtn as $rowJbtn): ?>
                <?php if($rowJbtn->IDJabatan == $row->PekerjaanID):?>
...
<div class="form-group">
    ...
    <div class="col-sm-9">
        <input type="number" id="inputTarget" name="txtTarget" onchange="changePermintaan()" value="<?php echo $row->TKTarget;?>"
...
<div class="form-group">
    ...
    <div class="col-sm-8">
        <select class="form-control" id="inputPemborong" name="comboPendidikan">
            ...
            <option value="<?php echo $rowPend->Pendidikan; ?>" <?php if($rowPend->Pendidikan == $row->Pendidikan){echo 'selected';}?> >
...
<div class="form-group">
    ...
    <div class="col-sm-8">
        <select class="form-control" id="inputStatus" name="comboStatus">
            ...
            <option value="<?php echo $rowSKwn->StatusKawin; ?>" <?php if($rowSKwn->StatusKawin == $row->StatusPersonal){echo 'selected';}?> >
...
<div class="form-group">
    <div class="col-md-offset-3 col-md-9">
        <input class="btn btn-sm btn-info" type="submit" name="simpan" value="Edit">
    </div>
</div>
</form>
<script>
