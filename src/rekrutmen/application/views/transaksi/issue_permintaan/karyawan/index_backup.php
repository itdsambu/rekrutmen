                    ...
                    <div class="widget-main">
                        ...
                        <div class="form-group">
                            ...
                            <div id="" class="col-sm-8">
                                <select class="form-control" id="txtSubJabatan" name="txtSubJabatan">
...
<script>
    ...
    $('#inputDept').change(function(e) {
        ...
        if (inputDept) {
            ...
            $.ajax({
                url: '<?= base_url() ?>issue/get_idealkry_',
                dataType: 'json',
                data: {
                    id: inputDept,
...
<!-- <script type="text/javascript">
    ...
    $(".btn_save").click(function(e) { // passing down the event
        console.log($('#formkaryawan[0] input, select').serialize())
        Swal.fire({
            title: 'Apakah anda yakin ingin menyimpan transaksi ini??',
            text: "",
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: "<?php echo base_url(); ?>issue/cekfirstkar",
                    type: 'POST',
                    // dataType : 'JSON',
                    data: $('#formkaryawan input, select').serialize(),
